...
fn test_function34(_param0 :&str ,mut _param1 :regex::NoExpand ,_param2 :&str ,_param3 :usize) {
    ...
    let _local2_param3_helper2 = &(_local2_param3_helper1);
    let _: std::borrow::Cow<'_, str> = regex::Regex::replacen(_local2_param0_helper2, _param2, _param3, _local2_param3_helper2);
}
...
fn main() {
    ...
    test_function34(_param0 ,_param1 ,_param2 ,_param3);
