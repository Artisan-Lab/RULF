...
fn test_function29(mut _param0 :regex::bytes::NoExpand) {
    ...
    let _: core::option::Option<std::borrow::Cow<'_, [u8]>> = <regex::bytes::ReplacerRef<'_, regex::bytes::ReplacerRef<'_, regex::bytes::NoExpand<'_>>> as regex::bytes::Replacer>::no_expansion(_local2_param0_helper1);
}
