...
fn test_function18(mut _param0 :regex::NoExpand ,_param1 :&str ,_param2 :&str ,_param3 :&str) {
    ...
    let _ = <regex::ReplacerRef<'_, regex::NoExpand<'_>> as regex::Replacer>::replace_append(_local4_param0_helper1, _local4_param1_helper2, _local4_param2_helper1);
}
