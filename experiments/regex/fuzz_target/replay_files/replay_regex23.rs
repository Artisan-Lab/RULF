...
fn test_function23(_param0 :&str ,_param1 :&str ,_param2 :&str ,_param3 :usize) {
    ...
    let _: std::borrow::Cow<'_, str> = regex::Regex::replacen(_local2_param0_helper2, _param2, _param3, _local0);
}
