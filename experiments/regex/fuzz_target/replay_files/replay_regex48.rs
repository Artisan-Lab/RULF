...
fn test_function48(mut _param0 :&str) {
    ...
    let _: regex::ReplacerRef<'_, regex::ReplacerRef<'_, &str>> = <regex::ReplacerRef<'_, &str> as regex::Replacer>::by_ref(_local1_param0_helper1);
}
