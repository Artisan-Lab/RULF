...
fn test_function55(mut _param0 :regex::NoExpand) {
    ...
    let _: core::option::Option<std::borrow::Cow<'_, str>> = <regex::ReplacerRef<'_, regex::ReplacerRef<'_, regex::NoExpand<'_>>> as regex::Replacer>::no_expansion(_local2_param0_helper1);
}
