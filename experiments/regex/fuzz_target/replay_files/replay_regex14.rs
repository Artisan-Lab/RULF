...
fn test_function14(_param0 :&str ,_param1 :&[u8] ,_param2 :&[u8]) {
    ...
    let mut _local1: std::borrow::Cow<'_, [u8]> = regex::bytes::Regex::replace(_local1_param0_helper2, _param1, _param2);
    let _local2_param0_helper1 = &mut (_local1);
    let _ = <std::borrow::Cow<'_, [u8]> as regex::bytes::Replacer>::by_ref(_local2_param0_helper1);
}
