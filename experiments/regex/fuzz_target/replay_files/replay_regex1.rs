...
fn test_function1(_param0 :&str ,mut _param1 :regex::bytes::NoExpand ,_param2 :&[u8]) {
    ...
    let _: std::borrow::Cow<'_, [u8]> = regex::bytes::Regex::replace(_local3_param0_helper2, _param2, _local2);
}
...
fn main() {
    ...
    test_function1(_param0 ,_param1 ,_param2);
