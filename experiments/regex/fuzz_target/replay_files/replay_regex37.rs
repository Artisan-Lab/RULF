...
fn test_function37(_param0 :&str ,_param1 :&str ,_param2 :usize ,_param3 :regex::NoExpand) {
    ...
    let mut _local1: std::borrow::Cow<'_, str> = regex::Regex::replacen(_local1_param0_helper2, _param1, _param2, _param3);
...
fn main() {
    ...
    let _param3 = regex::NoExpand(_to_str(data, 9 + 2 * dynamic_length, data.len()));
