...
fn test_function30(_param0 :&str ,mut _param1 :regex::NoExpand ,_param2 :&str) {
    ...
    let _: std::borrow::Cow<'_, str> = regex::Regex::replace(_local2_param0_helper2, _param2, _local2_param2_helper2);
}
