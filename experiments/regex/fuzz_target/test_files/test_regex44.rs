...
fn test_function44(_param0 :&str ,mut _param1 :regex::bytes::NoExpand ,_param2 :&[u8] ,_param3 :usize) {
    ...
    let _: std::borrow::Cow<'_, [u8]> = regex::bytes::Regex::replacen(_local3_param0_helper2, _param2, _param3, _local2);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        let _param1 = regex::bytes::NoExpand(_to_slice::<u8>(data, 9 + 1 * dynamic_length, 9 + 2 * dynamic_length));
