...
fn test_function5(_param0 :&str ,mut _param1 :&str ,_param2 :&str) {
    let _local0 = <regex::Regex as core::str::FromStr>::from_str(_param0);
    let _local1_param0_helper1 = &mut (_param1);
    let _local1 = <&str as regex::Replacer>::no_expansion(_local1_param0_helper1);
