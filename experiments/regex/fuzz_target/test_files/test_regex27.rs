...
fn test_function27(mut _param0 :regex::bytes::NoExpand ,_param1 :&str ,_param2 :&[u8] ,_param3 :usize) {
    ...
    let _: std::borrow::Cow<'_, [u8]> = regex::bytes::Regex::replacen(_local2_param0_helper2, _param2, _param3, _local2_param3_helper2);
}
