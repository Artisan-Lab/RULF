...
fn test_function6(mut _param0 :&str) {
    ...
    let mut _local1: core::option::Option<std::borrow::Cow<'_, str>> = <regex::ReplacerRef<'_, &str> as regex::Replacer>::no_expansion(_local1_param0_helper1);
