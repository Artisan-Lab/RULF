...
fn test_function25(mut _param0 :regex::bytes::NoExpand ,_param1 :&str ,_param2 :&[u8]) {
    ...
    let _: std::borrow::Cow<'_, [u8]> = regex::bytes::Regex::replace_all(_local2_param0_helper2, _param2, _local2_param2_helper2);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function25(_param0 ,_param1 ,_param2);
    });
}
