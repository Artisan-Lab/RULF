...
fn test_function4(mut _param0 :regex::bytes::NoExpand ,_param1 :&str ,_param2 :&[u8]) {
    ...
    let _local1 = <regex::bytes::Regex as core::str::FromStr>::from_str(_param1);
    ...
    let _local2_param2_helper2 = &(_local2_param2_helper1);
    let _: std::borrow::Cow<'_, [u8]> = regex::bytes::Regex::replace(_local2_param0_helper2, _param2, _local2_param2_helper2);
}
