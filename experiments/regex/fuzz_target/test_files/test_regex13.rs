...
fn test_function13(mut _param0 :&[u8] ,_param1 :&str ,_param2 :&[u8]) {
    let _local0_param0_helper1 = &mut (_param0);
    let _local0 = <&[u8] as regex::bytes::Replacer>::no_expansion(_local0_param0_helper1);
    ...
    let _: std::borrow::Cow<'_, [u8]> = regex::bytes::Regex::replace(_local2_param0_helper2, _param2, _local2_param2_helper1);
}
