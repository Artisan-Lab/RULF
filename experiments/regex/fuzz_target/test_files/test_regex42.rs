...
fn test_function42(_param0 :&str ,_param1 :&str ,_param2 :&str) {
    let _local0 = regex::Regex::new(_param0);
    let mut _local1 = regex::escape(_param1);
    let _local2_param0_helper1 = &mut (_local1);
    let _local2 = <std::string::String as regex::Replacer>::by_ref(_local2_param0_helper1);
    let _local3_param0_helper1 = _unwrap_result(_local0);
    let _local3_param0_helper2 = &(_local3_param0_helper1);
    let _: std::borrow::Cow<'_, str> = regex::Regex::replace(_local3_param0_helper2, _param2, _local2);
}
