...
fn test_function36(_param0 :i64 ,_param1 :&str) {
    let _local0 = monero::util::amount::SignedAmount::from_pico(_param0);
    ...
    let _ = <monero::util::amount::SignedAmount as std::cmp::Ord>::cmp(_local2_param0_helper1, _local2_param1_helper2);
}
