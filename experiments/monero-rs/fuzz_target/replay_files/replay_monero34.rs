...
fn test_function34(_param0 :u64 ,_param1 :&str) {
    ...
    let _ = <monero::util::amount::Amount as std::ops::SubAssign::<monero::util::amount::Amount>>::sub_assign(_local2_param0_helper1, _local2_param1_helper1);
}
