...
fn test_function7(_param0 :&[u8]) {
    ...
    let _local1 = <monero::util::key::PublicKey as monero::cryptonote::hash::Hashable>::hash_to_scalar(_local1_param0_helper2);
    let _ = monero::util::key::PrivateKey::to_bytes(_local1);
}
