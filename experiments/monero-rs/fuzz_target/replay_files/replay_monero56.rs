...
fn test_function56(_param0 :&[u8] ,_param1 :&[u8] ,_param2 :&[u8] ,_param3 :usize) {
    ...
    let _ = monero::cryptonote::onetime_key::KeyGenerator::one_time_key(_local4_param0_helper1, _param3);
}
...
fn main() {
    ...
    let _param2 = _to_slice::<u8>(data, 8 + 2 * dynamic_length, data.len());
    let _param3 = _to_usize(data, 0);
    test_function56(_param0 ,_param1 ,_param2 ,_param3);
