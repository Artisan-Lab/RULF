...
fn test_function31(_param0 :&[u8] ,_param1 :&[u8]) {
    ...
    let _local1 = monero::util::key::PrivateKey::from_slice(_param1);
    ...
    let _ = <monero::util::key::PrivateKey as std::cmp::PartialEq::<monero::util::key::PrivateKey>>::eq(_local2_param0_helper2, _local2_param1_helper2);
}
