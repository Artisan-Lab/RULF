...
fn test_function48(_param0 :&str ,_param1 :u64) {
    let mut _local0 = monero::util::amount::Amount::from_str_with_denomination(_param0);
    let mut _local1_param0_helper1 = _unwrap_result(_local0);
    let _local1_param0_helper2 = &mut (_local1_param0_helper1);
    let _ = <monero::util::amount::Amount as std::ops::DivAssign::<u64>>::div_assign(_local1_param0_helper2, _param1);
}
