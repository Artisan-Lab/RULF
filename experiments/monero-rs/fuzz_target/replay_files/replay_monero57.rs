...
fn test_function57(_param0 :&[u8] ,_param1 :&[u8] ,_param2 :&[u8] ,_param3 :usize) {
    ...
    let _ = monero::cryptonote::onetime_key::KeyGenerator::get_rvn_scalar(_local4_param0_helper1, _param3);
}
