...
fn test_function21(_param0 :&str ,_param1 :i64) {
    ...
    let mut _local1 = monero::util::amount::SignedAmount::abs(_local1_param0_helper1);
    let _local2_param0_helper1 = &mut (_local1);
    let _ = <monero::util::amount::SignedAmount as std::ops::MulAssign::<i64>>::mul_assign(_local2_param0_helper1, _param1);
}
