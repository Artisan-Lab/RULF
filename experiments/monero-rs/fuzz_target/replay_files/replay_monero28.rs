...
fn test_function28(_param0 :&str ,_param1 :i64) {
    ...
    let _local1 = <monero::util::amount::SignedAmount as std::ops::Rem::<i64>>::rem(_local1_param0_helper1, _param1);
    let _ = monero::util::amount::SignedAmount::is_positive(_local1);
}
