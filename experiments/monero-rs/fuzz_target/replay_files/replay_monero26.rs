...
fn test_function26(_param0 :&str ,_param1 :u64) {
    ...
    let mut _local1 = monero::util::amount::SignedAmount::to_unsigned(_local1_param0_helper1);
    let mut _local2_param0_helper1 = _unwrap_result(_local1);
    let _local2_param0_helper2 = &mut (_local2_param0_helper1);
    let _ = <monero::util::amount::Amount as std::ops::MulAssign::<u64>>::mul_assign(_local2_param0_helper2, _param1);
}
