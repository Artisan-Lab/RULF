...
fn test_function24(_param0 :&str ,_param1 :i64) {
    ...
    let _local1 = monero::util::amount::SignedAmount::checked_div(_local1_param0_helper1, _param1);
    let _local2_param0_helper1 = _unwrap_option(_local1);
    let _ = monero::util::amount::SignedAmount::as_xmr(_local2_param0_helper1);
}
