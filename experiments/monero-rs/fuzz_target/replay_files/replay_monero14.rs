...
fn test_function14(_param0 :&str) {
    ...
    let _local1 = <monero::util::amount::Amount as std::default::Default>::default();
    ...
    let _ = <monero::util::amount::Amount as std::cmp::Ord>::cmp(_local2_param0_helper2, _local2_param1_helper1);
}
