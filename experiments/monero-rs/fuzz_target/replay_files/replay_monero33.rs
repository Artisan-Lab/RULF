...
fn test_function33(_param0 :u64 ,_param1 :&str) {
    let mut _local0 = monero::util::amount::Amount::from_pico(_param0);
    ...
    let _ = <monero::util::amount::Amount as std::ops::AddAssign::<monero::util::amount::Amount>>::add_assign(_local2_param0_helper1, _local2_param1_helper1);
}
