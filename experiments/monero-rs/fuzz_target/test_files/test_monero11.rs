...
fn test_function11(_param0 :&str ,_param1 :u64) {
    ...
    let _local1 = monero::util::amount::Amount::checked_mul(_local1_param0_helper1, _param1);
    let _local2_param0_helper1 = _unwrap_option(_local1);
    let _ = monero::util::amount::Amount::as_pico(_local2_param0_helper1);
}
