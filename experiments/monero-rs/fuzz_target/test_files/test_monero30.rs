...
fn test_function30(_param0 :u8 ,_param1 :&[u8] ,_param2 :&[u8]) {
    ...
    let _ = monero::util::address::Address::standard(_local3_param0_helper1, _local3_param1_helper1, _local3_param2_helper1);
}
