...
fn test_function23(_param0 :&str ,_param1 :i64) {
    ...
    let _local1 = monero::util::amount::SignedAmount::checked_mul(_local1_param0_helper1, _param1);
    let _local2_param0_helper1 = _unwrap_option(_local1);
    let _ = monero::util::amount::SignedAmount::as_pico(_local2_param0_helper1);
}
