...
fn test_function2(_param0 :u64 ,_param1 :&str) {
    let _local0 = monero::util::amount::Amount::from_pico(_param0);
    ...
    let _ = monero::util::amount::Amount::checked_add(_local0, _local2_param1_helper1);
}
