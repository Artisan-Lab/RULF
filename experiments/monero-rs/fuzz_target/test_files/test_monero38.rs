...
fn test_function38(_param0 :i64 ,_param1 :&str) {
    ...
    let _ = <monero::util::amount::SignedAmount as std::ops::SubAssign::<monero::util::amount::SignedAmount>>::sub_assign(_local2_param0_helper1, _local2_param1_helper1);
}
