...
fn test_function6(_param0 :&str ,_param1 :&str) {
    let _local0 = url::Host::<std::string::String>::parse(_param0);
    let _local1 = url::Host::<std::string::String>::parse_opaque(_param1);
    ...
    let _: std::cmp::Ordering = <url::Host::<std::string::String> as std::cmp::Ord>::cmp(_local2_param0_helper2, _local2_param1_helper2);
}
