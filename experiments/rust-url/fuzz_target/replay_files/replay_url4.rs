...
fn test_function4(_param0 :&str ,_param1 :&str) {
    let _local0 = url::Url::options();
    let mut _local1 = url::ParseOptions::<'_>::parse(_local0, _param0);
    let mut _local2_param0_helper1 = _unwrap_result(_local1);
    let _local2_param0_helper2 = &mut (_local2_param0_helper1);
    let _ = url::quirks::set_search(_local2_param0_helper2, _param1);
}
