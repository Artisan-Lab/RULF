...
fn test_function71(_param0 :&str ,_param1 :&[u8]) {
    ...
    let mut _local1 = url::Url::path_segments_mut(_local1_param0_helper2);
    let mut _local2_param0_helper1 = _unwrap_result(_local1);
    let _local2_param0_helper2 = &mut (_local2_param0_helper1);
    let _: &mut url::PathSegmentsMut::<'_> = url::PathSegmentsMut::<'_>::extend(_local2_param0_helper2, _param1);
}
