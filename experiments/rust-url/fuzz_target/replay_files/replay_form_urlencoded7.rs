...
fn test_function7(_param0 :&str ,_param1 :&str ,_param2 :&str) {
    ...
    let _: &mut form_urlencoded::Serializer::<'_, &mut std::string::String> = form_urlencoded::Serializer::<'_, &mut std::string::String>::append_pair(_local2_param0_helper1, _param1, _param2);
}
