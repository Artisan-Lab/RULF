...
fn test_function12(_param0 :&str ,_param1 :&str) {
    let _local0 = url::quirks::domain_to_unicode(_param0);
    let mut _local1: std::result::Result::<url::Url, ()> = url::Url::from_directory_path(_local0);
    let mut _local2_param0_helper1 = _unwrap_result(_local1);
    let _local2_param0_helper2 = &mut (_local2_param0_helper1);
    let _ = url::quirks::set_port(_local2_param0_helper2, _param1);
}
