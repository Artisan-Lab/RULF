...
fn test_function15(_param0 :&str ,_param1 :&str) {
    let _local0 = url::Host::<std::string::String>::parse(_param0);
    let _local1 = url::Host::<std::string::String>::parse(_param1);
    ...
    let _: bool = <url::Host::<std::string::String> as std::cmp::PartialEq::<url::Host::<std::string::String>>>::eq(_local2_param0_helper2, _local2_param1_helper2);
}
