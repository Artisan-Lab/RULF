...
fn test_function1(_param0 :&str) {
    ...
    let mut _local1 = <std::string::String as form_urlencoded::Target>::finish(_local0);
    let mut _local2_param0_helper1 = &mut (_local1);
    let _local2_param0_helper2 = &mut (_local2_param0_helper1);
    let _ = <&mut std::string::String as form_urlencoded::Target>::as_mut_string(_local2_param0_helper2);
}
