...
fn test_function5(_param0 :&str ,_param1 :&str) {
    let _local0 = <url::Url as std::str::FromStr>::from_str(_param0);
    let _local1_param0_helper1 = _unwrap_result(_local0);
    let _local1_param0_helper2 = &(_local1_param0_helper1);
    let _local1 = url::Url::join(_local1_param0_helper2, _param1);
    let _local2_param0_helper1 = _unwrap_result(_local1);
    let _local2_param0_helper2 = &(_local2_param0_helper1);
    let _ = url::quirks::search(_local2_param0_helper2);
}
