...
fn test_function2(_param0 :&str) {
    ...
    let _local1 = <&mut std::string::String as form_urlencoded::Target>::finish(_local1_param0_helper1);
    let _: form_urlencoded::Serializer::<'_, &mut std::string::String> = form_urlencoded::Serializer::<'_, &mut std::string::String>::new(_local1);
}
