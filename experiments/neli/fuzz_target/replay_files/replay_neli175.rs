...
fn test_function175(_param0 :u8 ,_param1 :u8) {
    ...
    let _ = <neli::consts::netfilter::LogCmd as std::cmp::PartialOrd::<neli::consts::netfilter::LogCmd>>::partial_cmp(_local2_param0_helper1, _local2_param1_helper1);
}
...
fn main() {
    ...
    test_function175(_param0 ,_param1);
