...
fn test_function170(_param0 :u8 ,_param1 :u8) {
    ...
    let _ = <neli::consts::rtnl::Ntf as std::ops::SubAssign::<neli::consts::rtnl::Ntf>>::sub_assign(_local2_param0_helper1, _local1);
}
