...
fn test_function137(_param0 :u8 ,_param1 :u8) {
    ...
    let _ = <neli::consts::genl::CtrlCmd as std::cmp::PartialEq::<neli::consts::genl::CtrlCmd>>::eq(_local2_param0_helper1, _local2_param1_helper1);
}
