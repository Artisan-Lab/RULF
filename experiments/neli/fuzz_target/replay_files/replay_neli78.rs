...
fn test_function78(_param0 :u8) {
    ...
    let _local7 = <neli::consts::rtnl::RtTable as std::convert::From::<u8>>::from(_local6);
    let _ = neli::rtnl::RtmsgBuilder::rtm_table(_local2, _local7);
}
