...
fn test_function166(_param0 :u8 ,_param1 :u8) {
    ...
    let _ = <neli::consts::rtnl::Ntf as std::ops::BitXorAssign::<neli::consts::rtnl::Ntf>>::bitxor_assign(_local2_param0_helper1, _local1);
}
