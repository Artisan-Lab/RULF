...
fn test_function124(_param0 :u16 ,_param1 :u16) {
    ...
    let _ = <neli::consts::nl::NlmF as std::ops::BitAndAssign::<neli::consts::nl::NlmF>>::bitand_assign(_local2_param0_helper1, _local1);
}
