...
fn test_function3(_param0 :u32 ,_param1 :&[u32]) {
    let mut _local0 = neli::utils::Groups::new_bitmask(_param0);
    let _local1_param0_helper1 = &mut (_local0);
    let _ = neli::utils::Groups::remove_groups(_local1_param0_helper1, _param1);
}
