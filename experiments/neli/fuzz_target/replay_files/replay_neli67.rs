...
fn test_function67(_param0 :u16 ,_param1 :u16) {
    ...
    let _ = <neli::consts::rtnl::IflaInfo as std::cmp::PartialOrd::<neli::consts::rtnl::IflaInfo>>::partial_cmp(_local8_param0_helper1, _local8_param1_helper1);
}
