...
fn test_function193(_param0 :u16 ,_param1 :u16) {
    ...
    let _ = <neli::consts::rtnl::Rta as std::cmp::PartialEq::<neli::consts::rtnl::Rta>>::eq(_local8_param0_helper1, _local8_param1_helper1);
}
