...
fn test_function194(_param0 :u16 ,_param1 :u16) {
    ...
    let _ = <neli::consts::rtnl::Nda as std::cmp::PartialEq::<neli::consts::rtnl::Nda>>::eq(_local8_param0_helper1, _local8_param1_helper1);
}
...
fn main() {
    ...
    test_function194(_param0 ,_param1);
