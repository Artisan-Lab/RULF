...
fn test_function173(_param0 :u8 ,_param1 :u8) {
    ...
    let _ = <neli::consts::netfilter::LogCmd as std::cmp::Ord>::cmp(_local2_param0_helper1, _local2_param1_helper1);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function173(_param0 ,_param1);
    });
}
