...
fn test_function158(_param0 :u8 ,_param1 :u8) {
    ...
    let _ = <neli::consts::rtnl::IfaF as std::ops::SubAssign::<neli::consts::rtnl::IfaF>>::sub_assign(_local2_param0_helper1, _local1);
}
