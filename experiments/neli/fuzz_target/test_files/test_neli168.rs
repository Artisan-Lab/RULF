...
fn test_function168(_param0 :u8 ,_param1 :u8) {
    ...
    let _ = <neli::consts::rtnl::Ntf as std::ops::BitAndAssign::<neli::consts::rtnl::Ntf>>::bitand_assign(_local2_param0_helper1, _local1);
}
