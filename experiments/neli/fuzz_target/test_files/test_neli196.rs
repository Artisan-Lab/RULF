...
fn test_function196(_param0 :u16 ,_param1 :u16) {
    ...
    let _ = <neli::consts::rtnl::IflaInfo as std::cmp::Ord>::cmp(_local8_param0_helper1, _local8_param1_helper1);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function196(_param0 ,_param1);
    });
}
