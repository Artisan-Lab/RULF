...
fn test_function152(_param0 :u8 ,_param1 :u8) {
    ...
    let _ = <neli::consts::rtnl::IfaF as std::ops::BitOrAssign::<neli::consts::rtnl::IfaF>>::bitor_assign(_local2_param0_helper1, _local1);
}
