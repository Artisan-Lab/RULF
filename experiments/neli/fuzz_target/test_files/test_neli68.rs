...
fn test_function68(_param0 :u16 ,_param1 :u16) {
    ...
    let _local1 = <neli::consts::rtnl::Nud as std::convert::From::<u16>>::from(_param1);
    let _local2_param0_helper1 = &(_local0);
    let _local2_param1_helper1 = &(_local1);
    let _ = <neli::consts::rtnl::Nud as std::cmp::PartialEq::<neli::consts::rtnl::Nud>>::eq(_local2_param0_helper1, _local2_param1_helper1);
}
