...
fn test_function188(_param0 :u16 ,_param1 :u16) {
    ...
    let _local3 = <neli::consts::rtnl::Rta as std::convert::From::<u16>>::from(_local2);
    ...
    let _local7 = <neli::consts::rtnl::Rta as std::convert::From::<u16>>::from(_local6);
    let _local8_param0_helper1 = &(_local3);
    let _local8_param1_helper1 = &(_local7);
    let _ = <neli::consts::rtnl::Rta as std::cmp::PartialOrd::<neli::consts::rtnl::Rta>>::partial_cmp(_local8_param0_helper1, _local8_param1_helper1);
}
