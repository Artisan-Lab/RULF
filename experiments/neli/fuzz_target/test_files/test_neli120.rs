...
fn test_function120(_param0 :u16 ,_param1 :u16) {
    ...
    let _ = <neli::consts::nl::NlmF as std::ops::BitOrAssign::<neli::consts::nl::NlmF>>::bitor_assign(_local2_param0_helper1, _local1);
}
