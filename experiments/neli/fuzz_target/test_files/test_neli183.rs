...
fn test_function183(_param0 :u16) {
    ...
    let _local3 = <neli::consts::rtnl::Arphrd as std::convert::From::<u16>>::from(_local2);
    let _ = <libc::c_ushort as std::convert::From::<neli::consts::rtnl::Arphrd>>::from(_local3);
}
