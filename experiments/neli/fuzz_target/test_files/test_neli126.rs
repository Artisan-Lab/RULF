...
fn test_function126(_param0 :u16 ,_param1 :u16) {
    ...
    let _ = <neli::consts::nl::NlmF as std::ops::SubAssign::<neli::consts::nl::NlmF>>::sub_assign(_local2_param0_helper1, _local1);
}
