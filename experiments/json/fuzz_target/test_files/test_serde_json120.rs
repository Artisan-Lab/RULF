...
fn test_function120(_param0 :&str ,_param1 :isize) {
    ...
    let _ = <&serde_json::Value as std::cmp::PartialEq::<isize>>::eq(_local1_param0_helper2, _local1_param1_helper1);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        let _param1 = _to_isize(data, 0);
        test_function120(_param0 ,_param1);
    });
}
