...
fn test_function220(_param0 :f64 ,_param1 :serde_json::value::Serializer) {
    ...
    let _: serde_json::Result::<serde_json::Value> = <serde_json::value::Serializer as serde::ser::Serializer>::collect_str(_param1, _local1_param1_helper2);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function220(_param0 ,_param1);
    });
}
