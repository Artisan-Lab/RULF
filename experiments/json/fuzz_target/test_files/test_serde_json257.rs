...
fn test_function257(_param0 :usize ,_param1 :i64) {
    let _local0 = <serde_json::value::Number as std::convert::From::<usize>>::from(_param0);
    ...
    let _ = <&mut serde_json::Value as std::cmp::PartialEq::<i64>>::eq(_local2_param0_helper3, _local2_param1_helper1);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function257(_param0 ,_param1);
    });
}
