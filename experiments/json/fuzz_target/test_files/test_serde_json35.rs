...
fn test_function35(_param0 :&str ,_param1 :i64) {
    let mut _local0 = <serde_json::Value as std::str::FromStr>::from_str(_param0);
    let mut _local1_param0_helper1 = _unwrap_result(_local0);
    let _local1_param0_helper2 = &mut (_local1_param0_helper1);
    let _local1 = serde_json::Value::take(_local1_param0_helper2);
    let _local2_param0_helper1 = &(_param1);
    let _local2_param1_helper1 = &(_local1);
    let _ = <i64 as std::cmp::PartialEq::<serde_json::Value>>::eq(_local2_param0_helper1, _local2_param1_helper1);
}
