...
fn test_function258(_param0 :usize ,_param1 :isize) {
    ...
    let _ = <serde_json::Value as std::cmp::PartialEq::<isize>>::eq(_local2_param0_helper2, _local2_param1_helper1);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function258(_param0 ,_param1);
    });
}
