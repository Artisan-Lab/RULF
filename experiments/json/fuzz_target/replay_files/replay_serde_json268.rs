...
fn test_function268(_param0 :i16 ,_param1 :isize) {
    ...
    let _ = <isize as std::cmp::PartialEq::<serde_json::Value>>::eq(_local2_param0_helper1, _local2_param1_helper2);
}
