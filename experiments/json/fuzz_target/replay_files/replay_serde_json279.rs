...
fn test_function279(_param0 :i64 ,_param1 :f32) {
    let _local0 = <serde_json::value::Number as std::convert::From::<i64>>::from(_param0);
    ...
    let _ = <serde_json::Value as std::cmp::PartialEq::<f32>>::eq(_local2_param0_helper2, _local2_param1_helper1);
}
...
fn main() {
    ...
    test_function279(_param0 ,_param1);
