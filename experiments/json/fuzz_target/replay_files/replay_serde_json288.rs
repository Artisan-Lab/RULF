...
fn test_function288(_param0 :i64 ,_param1 :i64) {
    ...
    let _ = <i64 as std::cmp::PartialEq::<serde_json::Value>>::eq(_local2_param0_helper1, _local2_param1_helper2);
}
...
fn main() {
    ...
    test_function288(_param0 ,_param1);
