...
fn test_function185(_param0 :f64 ,_param1 :f64) {
    let _local0 = serde_json::value::Number::from_f64(_param0);
    let _local1 = serde_json::value::Number::from_f64(_param1);
    ...
    let _ = <serde_json::value::Number as std::cmp::PartialEq::<serde_json::value::Number>>::eq(_local2_param0_helper2, _local2_param1_helper2);
}
...
fn main() {
    ...
    test_function185(_param0 ,_param1);
