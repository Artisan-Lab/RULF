...
use std::ops::Index; // trait
use std::cmp::PartialEq; // trait
use std::convert::From; // trait

fn test_function295(_param0 :i64 ,_param1 :usize ,_param2 :i64) {
    ...
    let _ = <serde_json::Value as std::cmp::PartialEq::<i64>>::eq(_local1, _local2_param1_helper1);
}
