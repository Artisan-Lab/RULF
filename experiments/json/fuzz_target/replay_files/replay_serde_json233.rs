...
fn test_function233(_param0 :f64 ,_param1 :i64) {
    let _local0 = serde_json::value::Number::from_f64(_param0);
    let _local1_param0_helper1 = _unwrap_option(_local0);
    let _local1: std::result::Result::<serde_json::Value, serde_json::Error> = serde_json::to_value(_local1_param0_helper1);
...
fn main() {
    ...
    test_function233(_param0 ,_param1);
