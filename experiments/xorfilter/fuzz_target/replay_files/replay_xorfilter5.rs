...
fn test_function5(_param0 :&str ,_param1 :u32 ,_param2 :xorfilter::NoHash) {
    let _local0 = <std::vec::Vec::<u8, std::alloc::Global> as std::convert::From::<&str>>::from(_param0);
    let mut _local1: xorfilter::Fuse8::<xorfilter::NoHash> = xorfilter::Fuse8::<xorfilter::NoHash>::with_hasher(_param1, _param2);
    let _local2_param0_helper1 = &mut (_local1);
    let _local2_param1_helper1 = &(_local0);
    let _ = xorfilter::Fuse8::<xorfilter::NoHash>::insert(_local2_param0_helper1, _local2_param1_helper1);
}
