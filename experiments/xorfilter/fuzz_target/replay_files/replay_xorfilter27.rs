...
fn test_function27(_param0 :u32 ,_param1 :&[u64]) {
    ...
    let _: xorfilter::Result::<()> = xorfilter::Fuse16::<xorfilter::BuildHasherDefault>::build_keys(_local2_param0_helper1, _param1);
}
