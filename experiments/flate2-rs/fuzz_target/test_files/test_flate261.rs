...
fn test_function61(_param0 :u32 ,_param1 :&str ,_param2 :u32) {
    ...
    let _local5: flate2::write::GzDecoder::<flate2::write::GzEncoder::<std::vec::Vec::<u8, std::alloc::Global>>> = flate2::write::GzDecoder::<flate2::write::GzEncoder::<std::vec::Vec::<u8, std::alloc::Global>>>::new(_local4);
    let _: std::io::Result::<flate2::write::GzEncoder::<std::vec::Vec::<u8, std::alloc::Global>>> = flate2::write::GzDecoder::<flate2::write::GzEncoder::<std::vec::Vec::<u8, std::alloc::Global>>>::finish(_local5);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function61(_param0 ,_param1 ,_param2);
    });
}
