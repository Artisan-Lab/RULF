...
fn test_function19(_param0 :u32 ,_param1 :&str ,_param2 :u32 ,_param3 :u32) {
    ...
    let _local6: flate2::write::GzEncoder::<flate2::write::GzEncoder::<std::vec::Vec::<u8, std::alloc::Global>>> = flate2::write::GzEncoder::<flate2::write::GzEncoder::<std::vec::Vec::<u8, std::alloc::Global>>>::new(_local4, _local5);
    let _: std::io::Result::<flate2::write::GzEncoder::<std::vec::Vec::<u8, std::alloc::Global>>> = flate2::write::GzEncoder::<flate2::write::GzEncoder::<std::vec::Vec::<u8, std::alloc::Global>>>::finish(_local6);
}
