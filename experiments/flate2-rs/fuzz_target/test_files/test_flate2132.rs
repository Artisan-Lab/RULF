...
fn test_function132(_param0 :&str ,_param1 :u32 ,_param2 :bool) {
    ...
    let _: std::io::Result::<()> = <flate2::write::ZlibEncoder::<std::vec::Vec::<u8, std::alloc::Global>> as std::io::Write>::flush(_local4_param0_helper1);
}
