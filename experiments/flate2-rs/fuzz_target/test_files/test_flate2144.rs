...
fn test_function144(_param0 :u32 ,_param1 :&str ,_param2 :u32) {
    ...
    let _: flate2::write::ZlibDecoder::<flate2::write::GzEncoder::<std::vec::Vec::<u8, std::alloc::Global>>> = flate2::write::ZlibDecoder::<flate2::write::GzEncoder::<std::vec::Vec::<u8, std::alloc::Global>>>::new(_local4);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function144(_param0 ,_param1 ,_param2);
    });
}
