...
fn test_function55(_param0 :&str ,_param1 :u32 ,_param2 :bool) {
    ...
    let _local4: flate2::write::MultiGzDecoder::<flate2::write::ZlibEncoder::<std::vec::Vec::<u8, std::alloc::Global>>> = flate2::write::MultiGzDecoder::<flate2::write::ZlibEncoder::<std::vec::Vec::<u8, std::alloc::Global>>>::new(_local3);
    let _: std::io::Result::<flate2::write::ZlibEncoder::<std::vec::Vec::<u8, std::alloc::Global>>> = flate2::write::MultiGzDecoder::<flate2::write::ZlibEncoder::<std::vec::Vec::<u8, std::alloc::Global>>>::finish(_local4);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function55(_param0 ,_param1 ,_param2);
    });
}
