...
fn test_function112(_param0 :&str) {
    ...
    let _: &mut std::vec::Vec::<u8, std::alloc::Global> = flate2::CrcWriter::<std::vec::Vec::<u8, std::alloc::Global>>::get_mut(_local2_param0_helper1);
}
