...
fn test_function58(_param0 :u32 ,_param1 :&str ,_param2 :u32) {
    ...
    let _local5: flate2::CrcWriter::<flate2::write::GzEncoder::<std::vec::Vec::<u8, std::alloc::Global>>> = flate2::CrcWriter::<flate2::write::GzEncoder::<std::vec::Vec::<u8, std::alloc::Global>>>::new(_local4);
    let _: flate2::write::GzEncoder::<std::vec::Vec::<u8, std::alloc::Global>> = flate2::CrcWriter::<flate2::write::GzEncoder::<std::vec::Vec::<u8, std::alloc::Global>>>::into_inner(_local5);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function58(_param0 ,_param1 ,_param2);
    });
}
