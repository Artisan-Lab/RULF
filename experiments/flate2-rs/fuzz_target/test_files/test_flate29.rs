...
fn test_function9(_param0 :&str) {
    ...
    let _local1 = flate2::Compression::fast();
    let _local2_param0_helper1 = &mut (_local0);
    let _: flate2::write::GzEncoder::<&mut std::vec::Vec::<u8, std::alloc::Global>> = flate2::write::GzEncoder::<&mut std::vec::Vec::<u8, std::alloc::Global>>::new(_local2_param0_helper1, _local1);
}
