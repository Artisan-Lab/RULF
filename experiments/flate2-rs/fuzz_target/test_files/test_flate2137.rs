...
fn test_function137(_param0 :&str ,_param1 :u32 ,_param2 :bool) {
    ...
    let _: &std::vec::Vec::<u8, std::alloc::Global> = flate2::write::ZlibEncoder::<std::vec::Vec::<u8, std::alloc::Global>>::get_ref(_local4_param0_helper1);
}
