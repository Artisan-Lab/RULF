...
fn test_function134(_param0 :&str ,_param1 :u32 ,_param2 :bool) {
    ...
    let _: std::io::Result::<()> = flate2::write::ZlibEncoder::<std::vec::Vec::<u8, std::alloc::Global>>::try_finish(_local4_param0_helper1);
}
