...
fn test_function79(_param0 :u32 ,_param1 :&[u8]) {
    let _local0 = flate2::GzBuilder::new();
    let _local1 = flate2::Compression::new(_param0);
    let _: flate2::bufread::GzEncoder::<&[u8]> = flate2::GzBuilder::buf_read(_local0, _param1, _local1);
}
