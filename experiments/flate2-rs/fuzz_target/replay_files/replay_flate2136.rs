...
fn test_function136(_param0 :&str ,_param1 :u32 ,_param2 :bool ,_param3 :&[u8]) {
    ...
    let _: std::io::Result::<usize> = <flate2::write::ZlibEncoder::<std::vec::Vec::<u8, std::alloc::Global>> as std::io::Write>::write(_local4_param0_helper1, _param3);
}
...
fn main() {
    ...
    let _param3 = _to_slice::<u8>(data, 5 + 1 * dynamic_length, data.len());
    test_function136(_param0 ,_param1 ,_param2 ,_param3);
