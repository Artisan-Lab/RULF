...
fn test_function138(_param0 :&str ,_param1 :u32 ,_param2 :bool) {
    ...
    let _: flate2::write::ZlibDecoder::<flate2::write::ZlibEncoder::<std::vec::Vec::<u8, std::alloc::Global>>> = flate2::write::ZlibDecoder::<flate2::write::ZlibEncoder::<std::vec::Vec::<u8, std::alloc::Global>>>::new(_local3);
}
...
fn main() {
    ...
    test_function138(_param0 ,_param1 ,_param2);
