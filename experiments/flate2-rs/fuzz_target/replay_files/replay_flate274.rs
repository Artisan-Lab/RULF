...
fn test_function74(_param0 :u32 ,_param1 :&str ,_param2 :u32) {
    ...
    let _local3: flate2::CrcWriter::<std::vec::Vec::<u8, std::alloc::Global>> = flate2::CrcWriter::<std::vec::Vec::<u8, std::alloc::Global>>::new(_local2);
    let _local4 = flate2::Compression::new(_param2);
    let _: flate2::write::GzEncoder::<flate2::CrcWriter::<std::vec::Vec::<u8, std::alloc::Global>>> = flate2::GzBuilder::write(_local1, _local3, _local4);
}
...
fn main() {
    ...
    test_function74(_param0 ,_param1 ,_param2);
