...
fn test_function139(_param0 :&str ,_param1 :u32 ,_param2 :bool) {
    ...
    let _: u64 = flate2::write::ZlibEncoder::<std::vec::Vec::<u8, std::alloc::Global>>::total_out(_local4_param0_helper1);
}
...
fn main() {
    ...
    test_function139(_param0 ,_param1 ,_param2);
