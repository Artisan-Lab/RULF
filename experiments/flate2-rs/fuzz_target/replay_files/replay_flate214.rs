...
fn test_function14(_param0 :&str ,_param1 :u32 ,_param2 :bool) {
    ...
    let _: std::io::Result::<flate2::write::DeflateDecoder::<std::vec::Vec::<u8, std::alloc::Global>>> = flate2::write::ZlibEncoder::<flate2::write::DeflateDecoder::<std::vec::Vec::<u8, std::alloc::Global>>>::finish(_local4);
}
