...
fn test_function87(_param0 :&str ,_param1 :bool) {
    ...
    let _: flate2::write::ZlibDecoder::<flate2::CrcWriter::<std::vec::Vec::<u8, std::alloc::Global>>> = flate2::write::ZlibDecoder::<flate2::CrcWriter::<std::vec::Vec::<u8, std::alloc::Global>>>::new_with_decompress(_local1, _local2);
}
