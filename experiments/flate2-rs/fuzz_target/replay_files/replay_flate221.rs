...
fn test_function21(_param0 :u32 ,_param1 :&str ,_param2 :u32 ,_param3 :u32 ,_param4 :bool) {
    ...
    let _: std::io::Result::<flate2::write::GzEncoder::<std::vec::Vec::<u8, std::alloc::Global>>> = flate2::write::ZlibEncoder::<flate2::write::GzEncoder::<std::vec::Vec::<u8, std::alloc::Global>>>::finish(_local7);
}
