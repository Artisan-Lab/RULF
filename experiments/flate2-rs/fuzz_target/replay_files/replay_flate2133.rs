...
fn test_function133(_param0 :&str ,_param1 :u32 ,_param2 :bool) {
    ...
    let _: &mut std::vec::Vec::<u8, std::alloc::Global> = flate2::write::ZlibEncoder::<std::vec::Vec::<u8, std::alloc::Global>>::get_mut(_local4_param0_helper1);
}
...
fn main() {
    ...
    test_function133(_param0 ,_param1 ,_param2);
