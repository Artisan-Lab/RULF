...
fn test_function4(_param0 :&str ,_param1 :u32) {
    ...
    let _local3: flate2::write::GzEncoder::<flate2::CrcWriter::<std::vec::Vec::<u8, std::alloc::Global>>> = flate2::write::GzEncoder::<flate2::CrcWriter::<std::vec::Vec::<u8, std::alloc::Global>>>::new(_local1, _local2);
    let _: std::io::Result::<flate2::CrcWriter::<std::vec::Vec::<u8, std::alloc::Global>>> = flate2::write::GzEncoder::<flate2::CrcWriter::<std::vec::Vec::<u8, std::alloc::Global>>>::finish(_local3);
}
