...
fn test_function167(_param0 :i64 ,_param1 :u32 ,_param2 :u32 ,_param3 :chrono::offset::Utc) {
    ...
    let _local1 = <chrono::naive::NaiveDateTime as chrono::Datelike>::with_ordinal(_local1_param0_helper2, _param2);
    ...
    let _ = <chrono::offset::Utc as chrono::offset::TimeZone>::from_local_datetime(_local2_param0_helper1, _local2_param1_helper2);
}
