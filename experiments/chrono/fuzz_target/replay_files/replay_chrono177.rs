...
fn test_function177(_param0 :u32 ,_param1 :u32 ,_param2 :u32 ,_param3 :u32 ,_param4 :u32 ,_param5 :u32) {
    ...
    let _ = <chrono::naive::NaiveTime as std::cmp::PartialOrd::<chrono::naive::NaiveTime>>::partial_cmp(_local2_param0_helper1, _local2_param1_helper1);
}
...
fn main() {
    ...
    test_function177(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5);
