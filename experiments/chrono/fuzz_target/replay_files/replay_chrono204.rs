...
fn test_function204(_param0 :i32 ,_param1 :i32 ,_param2 :u32) {
    ...
    let _ = <chrono::offset::FixedOffset as chrono::offset::TimeZone>::yo(_local2_param0_helper1, _param1, _param2);
}
