...
fn test_function115(_param0 :i64 ,_param1 :u32 ,_param2 :chrono::offset::Utc) {
    ...
    let _ = <chrono::naive::NaiveDateTime as std::ops::Add::<chrono::offset::FixedOffset>>::add(_local0, _local1);
}
...
fn main() {
    ...
    test_function115(_param0 ,_param1 ,_param2);
