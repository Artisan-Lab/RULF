...
fn test_function117(_param0 :i64 ,_param1 :u32 ,_param2 :chrono::offset::Utc) {
    ...
    let _ = <chrono::offset::FixedOffset as chrono::offset::TimeZone>::offset_from_local_datetime(_local2_param0_helper1, _local2_param1_helper1);
}
...
fn main() {
    ...
    test_function117(_param0 ,_param1 ,_param2);
