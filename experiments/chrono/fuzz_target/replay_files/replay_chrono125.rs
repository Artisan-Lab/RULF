...
fn test_function125(_param0 :i64 ,_param1 :chrono::offset::Local) {
    ...
    let _ = <chrono::offset::Local as chrono::offset::TimeZone>::from_utc_date(_local2_param0_helper1, _local2_param1_helper1);
}
