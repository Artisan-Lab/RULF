...
fn test_function41(_param0 :i32 ,_param1 :u32 ,_param2 :u32 ,_param3 :u32 ,_param4 :&str) {
    let _local0 = chrono::naive::NaiveDate::from_ymd(_param0, _param1, _param2);
    let _local1_param0_helper1 = &(_local0);
    let _local1 = <chrono::naive::NaiveDate as chrono::Datelike>::with_day0(_local1_param0_helper1, _param3);
...
fn main() {
    ...
    test_function41(_param0 ,_param1 ,_param2 ,_param3 ,_param4);
