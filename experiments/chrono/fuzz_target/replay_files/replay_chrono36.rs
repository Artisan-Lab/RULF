...
fn test_function36(_param0 :i32 ,_param1 :u32 ,_param2 :u32 ,_param3 :&str) {
    let _local0 = chrono::naive::NaiveDate::from_ymd(_param0, _param1, _param2);
    let _local1_param0_helper1 = &(_local0);
    let _local1 = chrono::naive::NaiveDate::pred_opt(_local1_param0_helper1);
...
fn main() {
    ...
    let _param3 = _to_str(data, 12 + 0 * dynamic_length, data.len());
