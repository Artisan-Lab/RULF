...
fn test_function180(_param0 :u32 ,_param1 :u32 ,_param2 :u32 ,_param3 :u32) {
    let _local0 = chrono::naive::NaiveTime::from_hms(_param0, _param1, _param2);
    let _local1_param0_helper1 = &(_local0);
    let _local1 = <chrono::naive::NaiveTime as chrono::Timelike>::with_minute(_local1_param0_helper1, _param3);
    let _local2_param0_helper1 = _unwrap_option(_local1);
    let _local2_param0_helper2 = &(_local2_param0_helper1);
    let _ = <chrono::naive::NaiveTime as chrono::Timelike>::nanosecond(_local2_param0_helper2);
}
...
fn main() {
    ...
    test_function180(_param0 ,_param1 ,_param2 ,_param3);
