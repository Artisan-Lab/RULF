...
fn test_function241(_param0 :i32 ,_param1 :u32 ,_param2 :u32 ,_param3 :u32) {
    ...
    let _local1 = <chrono::naive::NaiveDate as chrono::Datelike>::with_month0(_local1_param0_helper2, _param3);
    let _local2_param0_helper1 = _unwrap_option(_local1);
    let _local2_param0_helper2 = &(_local2_param0_helper1);
    let _ = <chrono::naive::NaiveDate as chrono::Datelike>::num_days_from_ce(_local2_param0_helper2);
}
...
fn main() {
    ...
    test_function241(_param0 ,_param1 ,_param2 ,_param3);
