...
fn test_function276(_param0 :i32 ,_param1 :u32 ,_param2 :u32 ,_param3 :i64 ,_param4 :u32 ,_param5 :i64 ,_param6 :u32) {
    ...
    let _ = chrono::naive::NaiveDate::checked_add_signed(_local0, _local3);
}
...
fn main() {
    ...
    test_function276(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5 ,_param6);
