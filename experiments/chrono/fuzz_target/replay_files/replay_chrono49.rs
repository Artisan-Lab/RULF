...
fn test_function49(_param0 :u32 ,_param1 :u32 ,_param2 :u32 ,_param3 :u32 ,_param4 :&str) {
    let _local0 = chrono::naive::NaiveTime::from_hms_nano_opt(_param0, _param1, _param2, _param3);
...
fn main() {
    ...
    test_function49(_param0 ,_param1 ,_param2 ,_param3 ,_param4);
