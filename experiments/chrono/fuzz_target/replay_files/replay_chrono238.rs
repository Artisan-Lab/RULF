...
fn test_function238(_param0 :i32 ,_param1 :u32 ,_param2 :u32) {
    ...
    let _local1 = <chrono::naive::NaiveDate as chrono::Datelike>::weekday(_local1_param0_helper2);
    let _local2_param0_helper1 = &(_local1);
    let _ = chrono::Weekday::num_days_from_sunday(_local2_param0_helper1);
}
