...
fn test_function232(_param0 :i32 ,_param1 :u32 ,_param2 :u32 ,_param3 :i32 ,_param4 :u32 ,_param5 :u32) {
    ...
    let _ = <chrono::naive::NaiveDate as std::cmp::Ord>::cmp(_local2_param0_helper1, _local2_param1_helper1);
}
...
fn main() {
    ...
    test_function232(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5);
