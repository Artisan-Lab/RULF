...
fn test_function47(_param0 :u32 ,_param1 :u32 ,_param2 :u32 ,_param3 :u32 ,_param4 :&str) {
    let _local0 = chrono::naive::NaiveTime::from_hms_micro_opt(_param0, _param1, _param2, _param3);
    let _local1_param0_helper1 = _unwrap_option(_local0);
    let _local1_param0_helper2 = &(_local1_param0_helper1);
    let _ = chrono::naive::NaiveTime::format(_local1_param0_helper2, _param4);
}
...
fn main() {
    ...
    test_function47(_param0 ,_param1 ,_param2 ,_param3 ,_param4);
