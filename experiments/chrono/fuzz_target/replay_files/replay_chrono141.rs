...
fn test_function141(_param0 :i64 ,_param1 :chrono::offset::Utc) {
    ...
    let _ = <chrono::offset::Utc as chrono::offset::TimeZone>::offset_from_utc_date(_local2_param0_helper1, _local2_param1_helper1);
}
...
fn main() {
    ...
    test_function141(_param0 ,_param1);
