...
fn test_function3(_param0 :i64 ,_param1 :u32 ,_param2 :chrono::offset::Local ,_param3 :&str ,_param4 :&str) {
    ...
    let _local1 = <chrono::offset::Local as chrono::offset::TimeZone>::offset_from_utc_datetime(_local1_param0_helper1, _local1_param1_helper2);
    let _local2_param0_helper1 = &(_local1);
    let _ = <chrono::offset::FixedOffset as chrono::offset::TimeZone>::datetime_from_str(_local2_param0_helper1, _param3, _param4);
}
...
fn main() {
    ...
    let _param3 = _to_str(data, 12 + 0 * dynamic_length, 12 + 1 * dynamic_length);
    let _param4 = _to_str(data, 12 + 1 * dynamic_length, data.len());
    test_function3(_param0 ,_param1 ,_param2 ,_param3 ,_param4);
