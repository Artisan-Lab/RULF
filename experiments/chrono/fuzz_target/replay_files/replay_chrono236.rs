...
fn test_function236(_param0 :i32 ,_param1 :u32 ,_param2 :u32) {
    ...
    let _local1 = chrono::naive::NaiveDate::pred(_local1_param0_helper2);
    let _local2_param0_helper1 = &(_local1);
    let _ = <chrono::naive::NaiveDate as chrono::Datelike>::day0(_local2_param0_helper1);
}
...
fn main() {
    ...
    test_function236(_param0 ,_param1 ,_param2);
