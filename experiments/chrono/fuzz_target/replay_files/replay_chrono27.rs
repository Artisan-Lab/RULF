...
fn test_function27(_param0 :i64 ,_param1 :u32 ,_param2 :u32 ,_param3 :&str) {
    let _local0 = chrono::naive::NaiveDateTime::from_timestamp(_param0, _param1);
    let _local1_param0_helper1 = &(_local0);
    let _local1 = <chrono::naive::NaiveDateTime as chrono::Timelike>::with_minute(_local1_param0_helper1, _param2);
