...
fn test_function253(_param0 :u32 ,_param1 :u32 ,_param2 :u32 ,_param3 :i64 ,_param4 :u32 ,_param5 :i64 ,_param6 :u32) {
    ...
    let _ = <chrono::naive::NaiveTime as std::ops::Sub::<chrono::Duration>>::sub(_local0, _local3);
}
...
fn main() {
    ...
    test_function253(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5 ,_param6);
