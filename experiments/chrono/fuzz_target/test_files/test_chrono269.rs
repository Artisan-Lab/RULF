...
fn test_function269(_param0 :u32 ,_param1 :u32 ,_param2 :u32 ,_param3 :i64 ,_param4 :u32 ,_param5 :i64 ,_param6 :u32) {
    ...
    let _ = <chrono::naive::NaiveTime as std::ops::AddAssign::<chrono::Duration>>::add_assign(_local4_param0_helper1, _local3);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function269(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5 ,_param6);
    });
}
