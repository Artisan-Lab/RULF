...
fn test_function175(_param0 :u32 ,_param1 :u32 ,_param2 :u32 ,_param3 :u32 ,_param4 :u32 ,_param5 :u32) {
    ...
    let _ = chrono::naive::NaiveTime::signed_duration_since(_local0, _local1);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function175(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5);
    });
}
