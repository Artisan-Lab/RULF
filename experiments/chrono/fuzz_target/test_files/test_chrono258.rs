...
fn test_function258(_param0 :u32 ,_param1 :u32 ,_param2 :u32 ,_param3 :i64 ,_param4 :u32 ,_param5 :i64 ,_param6 :u32) {
    let mut _local0 = chrono::naive::NaiveTime::from_hms(_param0, _param1, _param2);
    ...
    let _ = <chrono::naive::NaiveTime as std::ops::SubAssign::<chrono::Duration>>::sub_assign(_local4_param0_helper1, _local3);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function258(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5 ,_param6);
    });
}
