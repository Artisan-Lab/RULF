...
fn test_function86(_param0 :i32 ,_param1 :u32 ,_param2 :u32 ,_param3 :i64) {
    ...
    let _ = chrono::naive::NaiveWeek::first_day(_local3_param0_helper1);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function86(_param0 ,_param1 ,_param2 ,_param3);
    });
}
