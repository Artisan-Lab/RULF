...
fn test_function1(_param0 :i64 ,_param1 :&str) {
    ...
    let _local1 = chrono::naive::NaiveDateTime::time(_local1_param0_helper2);
    let _local2_param0_helper1 = &(_local1);
    let _ = chrono::naive::NaiveTime::format(_local2_param0_helper1, _param1);
}
