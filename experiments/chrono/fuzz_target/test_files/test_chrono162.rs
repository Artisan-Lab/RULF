...
fn test_function162(_param0 :i64 ,_param1 :u32 ,_param2 :i32) {
    ...
    let _local1 = <chrono::naive::NaiveDateTime as chrono::Datelike>::with_year(_local1_param0_helper2, _param2);
    let _local2_param0_helper1 = _unwrap_option(_local1);
    let _local2_param0_helper2 = &(_local2_param0_helper1);
    let _ = <chrono::naive::NaiveDateTime as chrono::Timelike>::num_seconds_from_midnight(_local2_param0_helper2);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        let _param2 = _to_i32(data, 12);
        test_function162(_param0 ,_param1 ,_param2);
    });
}
