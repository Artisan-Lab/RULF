...
fn test_function138(_param0 :i64 ,_param1 :u32) {
    ...
    let _local1 = <chrono::naive::NaiveDateTime as chrono::Timelike>::with_nanosecond(_local1_param0_helper2, _param1);
    let _local2_param0_helper1 = _unwrap_option(_local1);
    let _local2_param0_helper2 = &(_local2_param0_helper1);
    let _ = <chrono::naive::NaiveDateTime as chrono::Datelike>::day(_local2_param0_helper2);
}
