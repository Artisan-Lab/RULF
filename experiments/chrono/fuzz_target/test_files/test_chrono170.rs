...
fn test_function170(_param0 :u64 ,_param1 :u64) {
    ...
    let _ = <chrono::naive::Days as std::cmp::PartialEq::<chrono::naive::Days>>::eq(_local2_param0_helper1, _local2_param1_helper1);
}
