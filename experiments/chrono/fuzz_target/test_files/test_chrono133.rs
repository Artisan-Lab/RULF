...
fn test_function133(_param0 :i64 ,_param1 :u32) {
    ...
    let _local1 = <chrono::naive::NaiveDateTime as chrono::Datelike>::with_ordinal(_local1_param0_helper2, _param1);
    let _local2_param0_helper1 = _unwrap_option(_local1);
    let _local2_param0_helper2 = &(_local2_param0_helper1);
    let _ = chrono::naive::NaiveDateTime::timestamp_subsec_micros(_local2_param0_helper2);
}
