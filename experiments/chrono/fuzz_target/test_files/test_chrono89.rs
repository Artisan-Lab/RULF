...
fn test_function89(_param0 :i32 ,_param1 :u32 ,_param2 :u32 ,_param3 :i32 ,_param4 :u32 ,_param5 :u32) {
    ...
    let _ = <chrono::naive::NaiveDateWeeksIterator as std::cmp::PartialEq::<chrono::naive::NaiveDateWeeksIterator>>::eq(_local4_param0_helper1, _local4_param1_helper1);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function89(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5);
    });
}
