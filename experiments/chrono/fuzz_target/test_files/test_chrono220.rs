...
fn test_function220(_param0 :u64 ,_param1 :u64) {
    ...
    let _ = <chrono::Month as std::cmp::PartialOrd::<chrono::Month>>::partial_cmp(_local2_param0_helper2, _local2_param1_helper2);
}
