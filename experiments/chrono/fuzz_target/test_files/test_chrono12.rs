...
fn test_function12(_param0 :i32 ,_param1 :u32 ,_param2 :u32 ,_param3 :u32 ,_param4 :u32 ,_param5 :u32 ,_param6 :&str) {
    ...
    let _local1 = chrono::naive::NaiveDate::and_hms(_local1_param0_helper2, _param3, _param4, _param5);
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function12(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5 ,_param6);
    });
}
