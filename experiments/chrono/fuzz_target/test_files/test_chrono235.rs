...
fn test_function235(_param0 :i32 ,_param1 :u32 ,_param2 :u32) {
    ...
    let _local1 = chrono::naive::NaiveDate::succ_opt(_local1_param0_helper2);
    let _local2_param0_helper1 = _unwrap_option(_local1);
    let _local2_param0_helper2 = &(_local2_param0_helper1);
    let _ = <chrono::naive::NaiveDate as chrono::Datelike>::day(_local2_param0_helper2);
}
