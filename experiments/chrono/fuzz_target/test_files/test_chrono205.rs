...
fn test_function205(_param0 :i32 ,_param1 :i32 ,_param2 :u32) {
    ...
    let _local1 = <chrono::offset::FixedOffset as chrono::offset::Offset>::fix(_local1_param0_helper2);
    let _local2_param0_helper1 = &(_local1);
    let _ = <chrono::offset::FixedOffset as chrono::offset::TimeZone>::yo_opt(_local2_param0_helper1, _param1, _param2);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function205(_param0 ,_param1 ,_param2);
    });
}
