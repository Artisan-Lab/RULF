...
fn test_function5(_param0 :u32 ,_param1 :u32 ,_param2 :u32 ,_param3 :u32 ,_param4 :&str) {
    let _local0 = chrono::naive::NaiveTime::from_hms(_param0, _param1, _param2);
    let _local1_param0_helper1 = &(_local0);
    let _local1 = <chrono::naive::NaiveTime as chrono::Timelike>::with_hour(_local1_param0_helper1, _param3);
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function5(_param0 ,_param1 ,_param2 ,_param3 ,_param4);
    });
}
