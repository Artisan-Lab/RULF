...
fn test_function116(_param0 :i64 ,_param1 :u32 ,_param2 :chrono::offset::Utc) {
    ...
    let _ = <chrono::naive::NaiveDateTime as std::ops::Sub::<chrono::offset::FixedOffset>>::sub(_local0, _local1);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function116(_param0 ,_param1 ,_param2);
    });
}
