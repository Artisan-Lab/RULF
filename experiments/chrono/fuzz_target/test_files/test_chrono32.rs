...
fn test_function32(_param0 :i32 ,_param1 :u32 ,_param2 :u32 ,_param3 :u32 ,_param4 :u32 ,_param5 :u32 ,_param6 :u32 ,_param7 :&str) {
    let _local0 = chrono::naive::NaiveDate::from_ymd(_param0, _param1, _param2);
    let _local1_param0_helper1 = &(_local0);
    let _local1 = chrono::naive::NaiveDate::and_hms_nano_opt(_local1_param0_helper1, _param3, _param4, _param5, _param6);
    let _local2_param0_helper1 = _unwrap_option(_local1);
    let _local2_param0_helper2 = &(_local2_param0_helper1);
    let _ = chrono::naive::NaiveDateTime::format(_local2_param0_helper2, _param7);
}
