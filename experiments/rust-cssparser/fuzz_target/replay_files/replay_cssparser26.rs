...
fn test_function26(_param0 :&str ,_param1 :&str) {
    ...
    let _local2 = cssparser::Parser::<'_, '_>::position(_local2_param0_helper1);
    let mut _local3 = cssparser::ParserInput::<'_>::new(_param1);
    let _local4_param0_helper1 = &mut (_local3);
    let _local4 = cssparser::Parser::<'_, '_>::new(_local4_param0_helper1);
    let _local5_param0_helper1 = &(_local4);
    let _local5 = cssparser::Parser::<'_, '_>::position(_local5_param0_helper1);
    let _local6_param0_helper1 = &(_local2);
    let _local6_param1_helper1 = &(_local5);
    let _ = <cssparser::SourcePosition as std::cmp::PartialEq::<cssparser::SourcePosition>>::eq(_local6_param0_helper1, _local6_param1_helper1);
}
