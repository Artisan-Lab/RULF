...
fn test_function198(_param0 :cssparser::UnicodeRange) {
    let _local0 = <cssparser::CowRcStr::<'_> as std::default::Default>::default();
    let _local1_param0_helper1 = &(_param0);
    let _local1 = <cssparser::UnicodeRange as cssparser::ToCss>::to_css_string(_local1_param0_helper1);
