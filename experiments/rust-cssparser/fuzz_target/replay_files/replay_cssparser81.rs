...
fn test_function81(_param0 :&str) {
    ...
    let _: cssparser::CssStringWriter::<'_, cssparser::CssStringWriter::<'_, std::string::String>> = cssparser::CssStringWriter::<'_, cssparser::CssStringWriter::<'_, std::string::String>>::new(_local2_param0_helper1);
}
