...
fn test_function2(_param0 :&str) {
    ...
    let _local1 = <cssparser::CowRcStr::<'_> as std::convert::From::<&str>>::from(_param0);
    let _local2_param0_helper1 = &(_local1);
    let _local2_param1_helper1 = &mut (_local0);
    let _ = <cssparser::CowRcStr::<'_> as std::hash::Hash>::hash(_local2_param0_helper1, _local2_param1_helper1);
}
