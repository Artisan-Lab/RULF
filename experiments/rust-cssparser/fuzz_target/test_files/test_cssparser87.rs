...
fn test_function87(_param0 :&str ,_param1 :cssparser::UnicodeRange) {
    ...
    let _: std::fmt::Result = <cssparser::UnicodeRange as cssparser::ToCss>::to_css(_local2_param0_helper1, _local2_param1_helper1);
}
