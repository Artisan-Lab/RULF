...
fn test_function1(_param0 :i64 ,_param1 :&str) {
    ...
    let _local0 = <i64 as cssparser::ToCss>::to_css_string(_local0_param0_helper1);
    let _local1 = <cssparser::CowRcStr::<'_> as std::convert::From::<std::string::String>>::from(_local0);
    let _local2_param0_helper1 = &(_local1);
    let _: bool = <cssparser::CowRcStr::<'_> as std::cmp::PartialEq::<str>>::eq(_local2_param0_helper1, _param1);
}
