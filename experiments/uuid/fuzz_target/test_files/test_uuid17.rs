...
fn test_function17(_param0 :&[u8]) {
    ...
    let _local1 = uuid::Uuid::as_braced(_local1_param0_helper2);
    let _ = <uuid::fmt::Braced as std::convert::AsRef::<uuid::Uuid>>::as_ref(_local1);
}
