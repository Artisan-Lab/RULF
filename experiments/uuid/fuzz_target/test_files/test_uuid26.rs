...
fn test_function26(_param0 :&[u8]) {
    ...
    let _local1 = uuid::fmt::Hyphenated::from_uuid(_local1_param0_helper1);
    let _local2_param0_helper1 = &(_local1);
    let _ = <uuid::fmt::Hyphenated as std::borrow::Borrow::<uuid::Uuid>>::borrow(_local2_param0_helper1);
}
