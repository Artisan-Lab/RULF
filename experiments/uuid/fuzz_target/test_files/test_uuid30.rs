...
fn test_function30(_param0 :&[u8]) {
    let _local0 = uuid::Builder::from_slice_le(_param0);
    let _local1_param0_helper1 = _unwrap_result(_local0);
    let _local1 = uuid::Builder::into_uuid(_local1_param0_helper1);
    let _local2_param0_helper1 = &(_local1);
    let _ = uuid::Uuid::as_fields(_local2_param0_helper1);
}
