...
fn test_function34(_param0 :&[u8]) {
    ...
    let _local1 = uuid::Uuid::as_hyphenated(_local1_param0_helper2);
    let _ = <uuid::fmt::Hyphenated as std::convert::AsRef::<uuid::Uuid>>::as_ref(_local1);
}
