...
fn test_function24(_param0 :&[u8]) {
    let _local0 = uuid::Uuid::from_slice(_param0);
    let _local1_param0_helper1 = _unwrap_result(_local0);
    let _local1 = <uuid::fmt::Urn as std::convert::From::<uuid::Uuid>>::from(_local1_param0_helper1);
    let _local2_param0_helper1 = &(_local1);
    let _ = <uuid::fmt::Urn as std::borrow::Borrow::<uuid::Uuid>>::borrow(_local2_param0_helper1);
}
