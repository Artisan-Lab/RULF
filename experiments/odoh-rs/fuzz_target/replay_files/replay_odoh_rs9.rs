...
fn test_function9(_param0 :&str ,mut _param1 :&[u8]) {
    ...
    let _: std::result::Result::<(), odoh_rs::Error> = <&odoh_rs::ObliviousDoHConfig as odoh_rs::Serialize>::serialize(_local2_param0_helper2, _local2_param1_helper1);
}
