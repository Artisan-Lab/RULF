...
fn test_function2(_param0 :&str ,_param1 :usize) {
    ...
    let _local1: odoh_rs::ObliviousDoHMessagePlaintext = odoh_rs::ObliviousDoHMessagePlaintext::new(_local0, _param1);
    let _local2_param0_helper1 = &(_local1);
    let _ = odoh_rs::ObliviousDoHMessagePlaintext::padding_len(_local2_param0_helper1);
}
