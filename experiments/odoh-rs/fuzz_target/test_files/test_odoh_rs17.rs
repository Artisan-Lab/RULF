...
fn test_function17(mut _param0 :&[u8] ,mut _param1 :&[u8]) {
    ...
    let _ = <odoh_rs::ObliviousDoHConfigContents as std::cmp::PartialEq::<odoh_rs::ObliviousDoHConfigContents>>::eq(_local2_param0_helper2, _local2_param1_helper2);
}
