...
fn test_function11(_param0 :&str ,mut _param1 :&[u8]) {
    ...
    let _local1: std::result::Result::<odoh_rs::ObliviousDoHConfigContents, odoh_rs::Error> = <odoh_rs::ObliviousDoHConfigContents as odoh_rs::Deserialize>::deserialize(_local1_param0_helper1);
    ...
    let _: std::result::Result::<(), odoh_rs::Error> = <&odoh_rs::ObliviousDoHConfigContents as odoh_rs::Serialize>::serialize(_local2_param0_helper2, _local2_param1_helper1);
}
