...
fn test_function0(_param0 :&str) {
    ...
    let _: std::option::Option::<term::terminfo::TerminfoTerminal::<std::vec::Vec::<u8, std::alloc::Global>>> = term::terminfo::TerminfoTerminal::<std::vec::Vec::<u8, std::alloc::Global>>::new(_local0);
}
