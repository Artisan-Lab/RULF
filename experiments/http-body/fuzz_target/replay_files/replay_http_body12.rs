...
fn test_function12(_param0 :&str ,_param1 :u64) {
    let _local0 = <std::string::String as std::convert::From::<&str>>::from(_param0);
    let _local1_param0_helper1 = &(_local0);
    let mut _local1 = <std::string::String as http_body::Body>::size_hint(_local1_param0_helper1);
    let _local2_param0_helper1 = &mut (_local1);
    let _ = http_body::SizeHint::set_exact(_local2_param0_helper1, _param1);
}
