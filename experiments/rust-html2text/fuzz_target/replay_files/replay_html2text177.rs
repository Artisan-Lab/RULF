...
fn test_function177(_param0 :usize ,_param1 :html2text::render::text_renderer::RichDecorator ,_param2 :usize) {
    ...
    let _ = <html2text::render::text_renderer::SubRenderer::<html2text::render::text_renderer::RichDecorator> as html2text::render::Renderer>::end_code(_local2_param0_helper1);
}
...
fn main() {
    ...
    test_function177(_param0 ,_param1 ,_param2);
