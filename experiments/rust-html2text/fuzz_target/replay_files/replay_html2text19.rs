...
fn test_function19(_param0 :usize ,_param1 :html2text::render::text_renderer::RichDecorator ,_param2 :&str) {
    ...
    let _ = <html2text::render::text_renderer::SubRenderer::<html2text::render::text_renderer::RichDecorator> as html2text::render::Renderer>::add_block_line(_local1_param0_helper1, _param2);
}
