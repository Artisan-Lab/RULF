...
fn test_function76(_param0 :usize ,_param1 :html2text::render::text_renderer::RichDecorator) {
    ...
    let _: std::string::String = html2text::render::text_renderer::SubRenderer::<html2text::render::text_renderer::RichDecorator>::into_string(_local0);
}
