...
fn test_function8(_param0 :usize ,_param1 :html2text::render::text_renderer::RichDecorator ,_param2 :usize ,_param3 :&str) {
    ...
    let _ = html2text::render::text_renderer::SubRenderer::<html2text::render::text_renderer::RichDecorator>::add_subblock(_local2_param0_helper1, _param3);
}
