...
fn test_function159(_param0 :usize ,_param1 :html2text::render::text_renderer::RichDecorator ,_param2 :usize) {
    ...
    let _ = <html2text::render::text_renderer::SubRenderer::<html2text::render::text_renderer::RichDecorator> as html2text::render::Renderer>::new_line(_local2_param0_helper1);
}
...
fn main() {
    ...
    test_function159(_param0 ,_param1 ,_param2);
