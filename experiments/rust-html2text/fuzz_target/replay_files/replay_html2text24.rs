...
fn test_function24(_param0 :usize ,_param1 :html2text::render::text_renderer::RichDecorator ,_param2 :&str) {
    ...
    let _ = <html2text::render::text_renderer::SubRenderer::<html2text::render::text_renderer::RichDecorator> as html2text::render::Renderer>::record_frag_start(_local1_param0_helper1, _param2);
}
...
fn main() {
    ...
    test_function24(_param0 ,_param1 ,_param2);
