...
fn test_function86(_param0 :usize ,_param1 :html2text::render::text_renderer::RichDecorator) {
    ...
    let _: usize = <html2text::render::text_renderer::SubRenderer::<html2text::render::text_renderer::RichDecorator> as html2text::render::Renderer>::width(_local1_param0_helper1);
}
