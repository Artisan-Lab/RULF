...
fn test_function181(_param0 :usize ,_param1 :html2text::render::text_renderer::RichDecorator ,_param2 :usize ,_param3 :i64) {
    ...
    let _: std::string::String = <html2text::render::text_renderer::SubRenderer::<html2text::render::text_renderer::RichDecorator> as html2text::render::Renderer>::ordered_item_prefix(_local2_param0_helper1, _param3);
}
