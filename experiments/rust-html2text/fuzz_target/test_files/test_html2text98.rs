...
fn test_function98(_param0 :usize ,_param1 :html2text::render::text_renderer::RichDecorator ,_param2 :usize) {
    ...
    let _: std::string::String = <html2text::render::text_renderer::SubRenderer::<html2text::render::text_renderer::RichDecorator> as html2text::render::Renderer>::header_prefix(_local1_param0_helper1, _param2);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function98(_param0 ,_param1 ,_param2);
    });
}
