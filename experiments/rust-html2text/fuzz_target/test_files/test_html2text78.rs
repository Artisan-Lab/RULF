...
fn test_function78(_param0 :usize ,_param1 :html2text::render::text_renderer::RichDecorator) {
    ...
    let _ = <html2text::render::text_renderer::SubRenderer::<html2text::render::text_renderer::RichDecorator> as html2text::render::Renderer>::start_block(_local1_param0_helper1);
}
