...
fn test_function169(_param0 :usize ,_param1 :html2text::render::text_renderer::RichDecorator ,_param2 :usize) {
    ...
    let _ = <html2text::render::text_renderer::SubRenderer::<html2text::render::text_renderer::RichDecorator> as html2text::render::Renderer>::end_link(_local2_param0_helper1);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function169(_param0 ,_param1 ,_param2);
    });
}
