...
fn test_function22(_param0 :usize ,_param1 :html2text::render::text_renderer::RichDecorator ,_param2 :&str) {
    ...
    let _ = <html2text::render::text_renderer::SubRenderer::<html2text::render::text_renderer::RichDecorator> as html2text::render::Renderer>::start_link(_local1_param0_helper1, _param2);
}
