...
fn test_function47(_param0 :&str ,_param1 :i32) {
    let _local0 = <toml::Value as std::convert::From::<&str>>::from(_param0);
    let _local1 = <toml::Value as std::convert::From::<i32>>::from(_param1);
    let _local2_param0_helper1 = &(_local0);
    let _local2_param1_helper1 = &(_local1);
    let _ = toml::Value::same_type(_local2_param0_helper1, _local2_param1_helper1);
}
