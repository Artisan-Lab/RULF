...
fn test_function65(_param0 :&[u8] ,_param1 :&[u8] ,mut _param2 :u32 ,mut _param3 :u32) {
    ...
    let _ = <u32 as subtle::ConditionallySelectable>::conditional_swap(_local1_param0_helper1, _local1_param1_helper1, _local0);
}
