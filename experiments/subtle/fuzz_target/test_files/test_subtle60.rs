...
fn test_function60(_param0 :&[u8] ,_param1 :&[u8] ,_param2 :i16 ,_param3 :i16) {
    ...
    let _ = <i16 as subtle::ConditionallySelectable>::conditional_select(_local1_param0_helper1, _local1_param1_helper1, _local0);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function60(_param0 ,_param1 ,_param2 ,_param3);
    });
}
