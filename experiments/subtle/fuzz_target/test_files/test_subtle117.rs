...
fn test_function117(_param0 :i8 ,_param1 :i8 ,_param2 :u64 ,_param3 :i8 ,_param4 :i8 ,_param5 :u64) {
    ...
    let _: subtle::Choice = <subtle::CtOption::<u64> as subtle::ConstantTimeEq>::ct_ne(_local4_param0_helper1, _local4_param1_helper1);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function117(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5);
    });
}
