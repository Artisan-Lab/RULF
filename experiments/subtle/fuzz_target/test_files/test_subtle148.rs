...
fn test_function148(_param0 :u128 ,_param1 :u128 ,_param2 :u128 ,_param3 :u128) {
    ...
    let _local1 = <u128 as subtle::ConstantTimeEq>::ct_eq(_local1_param0_helper1, _local1_param1_helper1);
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function148(_param0 ,_param1 ,_param2 ,_param3);
    });
}
