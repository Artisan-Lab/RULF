...
fn test_function111(_param0 :i8 ,_param1 :i8 ,_param2 :i8 ,_param3 :i8 ,_param4 :i8 ,_param5 :i8 ,_param6 :i8 ,_param7 :i8 ,_param8 :i8 ,_param9 :i8) {
    ...
    let _ = <subtle::CtOption::<subtle::Choice> as subtle::ConditionallySelectable>::conditional_assign(_local7_param0_helper1, _local7_param1_helper1, _local6);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function111(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5 ,_param6 ,_param7 ,_param8 ,_param9);
    });
}
