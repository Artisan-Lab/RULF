...
fn test_function28(_param0 :i8 ,_param1 :i8 ,_param2 :i8 ,_param3 :i8 ,_param4 :i8 ,_param5 :i8) {
    ...
    let _ = <subtle::Choice as subtle::ConditionallySelectable>::conditional_select(_local3_param0_helper1, _local3_param1_helper1, _local2);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function28(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5);
    });
}
