...
fn test_function34(_param0 :u16 ,_param1 :u16 ,mut _param2 :i128 ,mut _param3 :i128) {
    ...
    let _ = <i128 as subtle::ConditionallySelectable>::conditional_swap(_local2_param0_helper1, _local2_param1_helper1, _local1);
}
