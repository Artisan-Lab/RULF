...
fn test_function39(_param0 :u128 ,_param1 :u128 ,mut _param2 :u8 ,_param3 :u8) {
    ...
    let _ = <u8 as subtle::ConditionallySelectable>::conditional_assign(_local2_param0_helper1, _local2_param1_helper1, _local1);
}
