...
fn test_function133(_param0 :i8 ,_param1 :i8 ,_param2 :i8 ,_param3 :i8 ,_param4 :i8 ,_param5 :i8 ,_param6 :i8 ,_param7 :i8) {
    ...
    let _: subtle::Choice = <subtle::CtOption::<subtle::Choice> as subtle::ConstantTimeEq>::ct_eq(_local6_param0_helper1, _local6_param1_helper1);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function133(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5 ,_param6 ,_param7);
    });
}
