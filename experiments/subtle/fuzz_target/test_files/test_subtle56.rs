...
fn test_function56(_param0 :&[u8] ,_param1 :&[u8] ,mut _param2 :u128 ,_param3 :u128) {
    ...
    let _ = <u128 as subtle::ConditionallySelectable>::conditional_assign(_local1_param0_helper1, _local1_param1_helper1, _local0);
}
