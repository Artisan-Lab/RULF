...
fn test_function140(_param0 :u16 ,_param1 :u16 ,_param2 :u16 ,_param3 :u16) {
    ...
    let _local1 = <u16 as subtle::ConstantTimeGreater>::ct_gt(_local1_param0_helper1, _local1_param1_helper1);
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function140(_param0 ,_param1 ,_param2 ,_param3);
    });
}
