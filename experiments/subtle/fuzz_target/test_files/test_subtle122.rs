...
fn test_function122(_param0 :i8 ,_param1 :i8 ,_param2 :i8 ,_param3 :i8 ,_param4 :i8 ,_param5 :i8) {
    ...
    let _: subtle::Choice = subtle::CtOption::<subtle::Choice>::unwrap_or(_local2, _local3);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function122(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5);
    });
}
