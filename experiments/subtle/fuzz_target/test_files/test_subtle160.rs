...
fn test_function160(_param0 :u32 ,_param1 :u32 ,_param2 :u32 ,_param3 :u32) {
    let _local0_param0_helper1 = &(_param0);
    let _local0_param1_helper1 = &(_param1);
    let _local0 = <u32 as subtle::ConstantTimeGreater>::ct_gt(_local0_param0_helper1, _local0_param1_helper1);
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function160(_param0 ,_param1 ,_param2 ,_param3);
    });
}
