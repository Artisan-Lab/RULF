...
fn test_function144(_param0 :i64 ,_param1 :i64 ,_param2 :i64 ,_param3 :i64) {
    ...
    let _local1 = <i64 as subtle::ConstantTimeEq>::ct_eq(_local1_param0_helper1, _local1_param1_helper1);
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function144(_param0 ,_param1 ,_param2 ,_param3);
    });
}
