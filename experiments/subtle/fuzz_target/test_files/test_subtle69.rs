...
fn test_function69(_param0 :&[u8] ,_param1 :&[u8] ,mut _param2 :i128 ,mut _param3 :i128) {
    ...
    let _ = <i128 as subtle::ConditionallySelectable>::conditional_swap(_local1_param0_helper1, _local1_param1_helper1, _local0);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function69(_param0 ,_param1 ,_param2 ,_param3);
    });
}
