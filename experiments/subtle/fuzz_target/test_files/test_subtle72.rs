...
fn test_function72(_param0 :&[u8] ,_param1 :&[u8] ,mut _param2 :u64 ,mut _param3 :u64) {
    ...
    let _ = <u64 as subtle::ConditionallySelectable>::conditional_swap(_local1_param0_helper1, _local1_param1_helper1, _local0);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        let _param3 = _to_u64(data, 8);
        test_function72(_param0 ,_param1 ,_param2 ,_param3);
    });
}
