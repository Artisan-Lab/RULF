...
fn test_function17(_param0 :u64 ,_param1 :u64 ,_param2 :u128 ,_param3 :u128) {
    ...
    let _ = <u128 as subtle::ConditionallySelectable>::conditional_select(_local2_param0_helper1, _local2_param1_helper1, _local1);
}
