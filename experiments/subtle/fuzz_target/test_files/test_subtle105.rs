...
fn test_function105(_param0 :i8 ,_param1 :i8 ,_param2 :u32 ,_param3 :i8 ,_param4 :i8 ,_param5 :u32 ,_param6 :i8 ,_param7 :i8) {
    ...
    let _local1: subtle::CtOption::<u32> = subtle::CtOption::<u32>::new(_param2, _local0);
    ...
    let _local3: subtle::CtOption::<u32> = subtle::CtOption::<u32>::new(_param5, _local2);
    ...
    let _: subtle::CtOption::<u32> = <subtle::CtOption::<u32> as subtle::ConditionallySelectable>::conditional_select(_local5_param0_helper1, _local5_param1_helper1, _local4);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        let _param5 = _to_u32(data, 8);
        let _param6 = _to_i8(data, 12);
        let _param7 = _to_i8(data, 13);
        test_function105(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5 ,_param6 ,_param7);
    });
}
