...
fn test_function147(_param0 :i64 ,_param1 :i64 ,_param2 :u32) {
    ...
    let _: subtle::CtOption::<u32> = subtle::CtOption::<u32>::new(_param2, _local1);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function147(_param0 ,_param1 ,_param2);
    });
}
