...
fn test_function55(_param0 :&[u8] ,_param1 :&[u8] ,_param2 :u128 ,_param3 :u128) {
    ...
    let _ = <u128 as subtle::ConditionallySelectable>::conditional_select(_local1_param0_helper1, _local1_param1_helper1, _local0);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function55(_param0 ,_param1 ,_param2 ,_param3);
    });
}
