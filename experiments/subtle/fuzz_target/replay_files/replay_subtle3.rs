...
fn test_function3(_param0 :i64 ,_param1 :i64 ,_param2 :i64 ,_param3 :i64) {
    let _local0_param0_helper1 = &(_param0);
    let _local0_param1_helper1 = &(_param1);
    let mut _local0 = <i64 as subtle::ConstantTimeEq>::ct_eq(_local0_param0_helper1, _local0_param1_helper1);
    let _local1_param0_helper1 = &(_param2);
    let _local1_param1_helper1 = &(_param3);
    let _local1 = <i64 as subtle::ConstantTimeEq>::ct_ne(_local1_param0_helper1, _local1_param1_helper1);
...
fn main() {
    ...
    test_function3(_param0 ,_param1 ,_param2 ,_param3);
