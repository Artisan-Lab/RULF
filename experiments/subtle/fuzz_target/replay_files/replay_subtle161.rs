...
fn test_function161(_param0 :u32 ,_param1 :u32 ,_param2 :u32 ,_param3 :u32) {
    ...
    let _local1 = <u32 as subtle::ConstantTimeGreater>::ct_gt(_local1_param0_helper1, _local1_param1_helper1);
...
fn main() {
    ...
    test_function161(_param0 ,_param1 ,_param2 ,_param3);
