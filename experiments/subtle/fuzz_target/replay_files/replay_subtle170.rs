...
fn test_function170(_param0 :u8 ,_param1 :u8 ,_param2 :u64 ,_param3 :u64) {
    ...
    let _local1 = <u64 as subtle::ConstantTimeLess>::ct_lt(_local1_param0_helper1, _local1_param1_helper1);
...
fn main() {
    ...
    let _param3 = _to_u64(data, 10);
    test_function170(_param0 ,_param1 ,_param2 ,_param3);
