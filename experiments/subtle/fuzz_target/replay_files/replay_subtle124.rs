...
fn test_function124(_param0 :i8 ,_param1 :i8 ,_param2 :i16 ,_param3 :i8 ,_param4 :i8 ,_param5 :i16) {
    ...
    let _: subtle::Choice = <subtle::CtOption::<i16> as subtle::ConstantTimeEq>::ct_eq(_local4_param0_helper1, _local4_param1_helper1);
}
...
fn main() {
    ...
    test_function124(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5);
