...
fn test_function22(_param0 :u8 ,_param1 :u8 ,_param2 :i16 ,_param3 :i16) {
    ...
    let _ = <i16 as subtle::ConditionallySelectable>::conditional_select(_local2_param0_helper1, _local2_param1_helper1, _local1);
}
