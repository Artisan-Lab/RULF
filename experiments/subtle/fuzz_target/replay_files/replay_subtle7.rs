...
fn test_function7(_param0 :i16 ,_param1 :i16 ,_param2 :i16 ,_param3 :i16) {
    ...
    let _ = <subtle::Choice as subtle::ConstantTimeEq>::ct_eq(_local2_param0_helper1, _local2_param1_helper1);
}
