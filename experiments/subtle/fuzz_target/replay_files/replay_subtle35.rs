...
fn test_function35(_param0 :u16 ,_param1 :u16 ,_param2 :u64 ,_param3 :u64) {
    ...
    let _ = <u64 as subtle::ConditionallySelectable>::conditional_select(_local2_param0_helper1, _local2_param1_helper1, _local1);
}
