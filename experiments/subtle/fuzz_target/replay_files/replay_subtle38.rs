...
fn test_function38(_param0 :i64 ,_param1 :i64 ,_param2 :u8 ,_param3 :u8) {
    ...
    let _ = <u8 as subtle::ConditionallySelectable>::conditional_select(_local2_param0_helper1, _local2_param1_helper1, _local1);
}
