...
fn test_function98(_param0 :i8 ,_param1 :i8 ,_param2 :u8 ,_param3 :i8 ,_param4 :i8 ,_param5 :u8 ,_param6 :i8 ,_param7 :i8) {
    ...
    let _local1: subtle::CtOption::<u8> = subtle::CtOption::<u8>::new(_param2, _local0);
    ...
    let _: subtle::CtOption::<u8> = <subtle::CtOption::<u8> as subtle::ConditionallySelectable>::conditional_select(_local5_param0_helper1, _local5_param1_helper1, _local4);
}
...
fn main() {
    ...
    test_function98(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5 ,_param6 ,_param7);
