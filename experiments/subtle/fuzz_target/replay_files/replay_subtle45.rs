...
use std::ops::BitOr; // trait

fn test_function45(_param0 :&[u8] ,_param1 :&[u8] ,_param2 :usize ,_param3 :usize) {
    let _local0: subtle::Choice = <[u8] as subtle::ConstantTimeEq>::ct_ne(_param0, _param1);
    let _local1_param0_helper1 = &(_param2);
    let _local1_param1_helper1 = &(_param3);
    let _local1 = <usize as subtle::ConstantTimeEq>::ct_eq(_local1_param0_helper1, _local1_param1_helper1);
...
fn main() {
    ...
    test_function45(_param0 ,_param1 ,_param2 ,_param3);
