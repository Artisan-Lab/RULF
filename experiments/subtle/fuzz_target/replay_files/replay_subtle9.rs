...
fn test_function9(_param0 :u32 ,_param1 :u32 ,mut _param2 :i8 ,_param3 :i8) {
    ...
    let _ = <i8 as subtle::ConditionallySelectable>::conditional_assign(_local2_param0_helper1, _local2_param1_helper1, _local1);
}
