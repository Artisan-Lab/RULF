...
fn test_function108(_param0 :i8 ,_param1 :i8 ,_param2 :i32 ,_param3 :i8 ,_param4 :i8 ,_param5 :i32 ,_param6 :i8 ,_param7 :i8) {
    ...
    let _ = <subtle::CtOption::<i32> as subtle::ConditionallySelectable>::conditional_assign(_local5_param0_helper1, _local5_param1_helper1, _local4);
}
...
fn main() {
    ...
    test_function108(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5 ,_param6 ,_param7);
