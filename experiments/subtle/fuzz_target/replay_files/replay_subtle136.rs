...
fn test_function136(_param0 :u16 ,_param1 :u16 ,_param2 :u16 ,_param3 :u16) {
    ...
    let _local1 = <u16 as subtle::ConstantTimeEq>::ct_eq(_local1_param0_helper1, _local1_param1_helper1);
