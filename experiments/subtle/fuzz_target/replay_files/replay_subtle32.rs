...
fn test_function32(_param0 :i8 ,_param1 :i8 ,_param2 :i128 ,_param3 :i128) {
    ...
    let _ = <i128 as subtle::ConditionallySelectable>::conditional_select(_local2_param0_helper1, _local2_param1_helper1, _local1);
}
...
fn main() {
    ...
    let _param3 = _to_i128(data, 18);
    test_function32(_param0 ,_param1 ,_param2 ,_param3);
