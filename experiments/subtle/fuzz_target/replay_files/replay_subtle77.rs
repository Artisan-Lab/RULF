...
fn test_function77(_param0 :&[u8] ,_param1 :&[u8] ,mut _param2 :i32 ,_param3 :i32) {
    ...
    let _ = <i32 as subtle::ConditionallySelectable>::conditional_assign(_local1_param0_helper1, _local1_param1_helper1, _local0);
}
