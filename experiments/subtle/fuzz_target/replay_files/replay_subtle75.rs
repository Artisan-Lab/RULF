...
fn test_function75(_param0 :&[u8] ,_param1 :&[u8] ,mut _param2 :u8 ,mut _param3 :u8) {
    ...
    let _ = <u8 as subtle::ConditionallySelectable>::conditional_swap(_local1_param0_helper1, _local1_param1_helper1, _local0);
}
...
fn main() {
    ...
    test_function75(_param0 ,_param1 ,_param2 ,_param3);
