...
fn test_function83(_param0 :&[u8] ,_param1 :&[u8] ,_param2 :u32) {
    ...
    let _: std::option::Option::<*const u32> = <std::option::Option::<*const u32> as std::convert::From::<subtle::CtOption::<*const u32>>>::from(_local1);
}
