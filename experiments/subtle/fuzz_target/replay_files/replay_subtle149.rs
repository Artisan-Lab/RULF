...
fn test_function149(_param0 :u128 ,_param1 :u128 ,_param2 :usize) {
    ...
    let _: subtle::CtOption::<usize> = subtle::CtOption::<usize>::new(_param2, _local1);
}
...
fn main() {
    ...
    test_function149(_param0 ,_param1 ,_param2);
