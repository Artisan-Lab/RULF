...
fn test_function50(_param0 :&[u8] ,_param1 :&[u8] ,mut _param2 :u16 ,_param3 :u16) {
    ...
    let _ = <u16 as subtle::ConditionallySelectable>::conditional_assign(_local1_param0_helper1, _local1_param1_helper1, _local0);
}
...
fn main() {
    ...
    test_function50(_param0 ,_param1 ,_param2 ,_param3);
