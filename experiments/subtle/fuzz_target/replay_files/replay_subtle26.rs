...
fn test_function26(_param0 :usize ,_param1 :usize ,mut _param2 :u32 ,_param3 :u32) {
    ...
    let _ = <u32 as subtle::ConditionallySelectable>::conditional_assign(_local2_param0_helper1, _local2_param1_helper1, _local1);
}
