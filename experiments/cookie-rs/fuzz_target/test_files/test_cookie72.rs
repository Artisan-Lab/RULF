...
#[macro_use]
extern crate afl;
fn test_function72(_param0 :cookie::prefix::Secure ,_param1 :cookie::prefix::Host) {
    ...
    let _ = cookie::prefix::PrefixedJar::<cookie::prefix::Secure, &cookie::CookieJar>::remove(_local2_param0_helper1, _local2_param1_helper1);
}
