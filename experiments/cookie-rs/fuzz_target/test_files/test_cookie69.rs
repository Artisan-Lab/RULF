...
#[macro_use]
extern crate afl;
fn test_function69(_param0 :cookie::prefix::Host ,_param1 :cookie::prefix::Host) {
    ...
    let _ = cookie::prefix::PrefixedJar::<cookie::prefix::Host, &mut cookie::CookieJar>::add(_local2_param0_helper1, _local2_param1_helper1);
}
