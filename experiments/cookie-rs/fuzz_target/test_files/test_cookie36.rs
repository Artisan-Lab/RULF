...
fn test_function36(_param0 :&str ,_param1 :&str) {
    let mut _local0 = <cookie::Cookie::<'_> as std::str::FromStr>::from_str(_param0);
    let _local1 = <cookie::Cookie::<'_> as std::str::FromStr>::from_str(_param1);
    ...
    let _ = cookie::Cookie::<'_>::set_expires(_local3_param0_helper2, _local3_param1_helper1);
}
