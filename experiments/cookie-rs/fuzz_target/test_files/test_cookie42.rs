...
fn test_function42(_param0 :&str ,_param1 :&str) {
    ...
    let _ = <cookie::Cookie::<'_> as std::cmp::PartialEq::<cookie::CookieBuilder::<'_>>>::eq(_local3_param0_helper2, _local3_param1_helper1);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function42(_param0 ,_param1);
    });
}
