...
fn test_function45(_param0 :&str ,_param1 :&str) {
    ...
    let _ = <cookie::SameSite as std::cmp::PartialEq::<cookie::SameSite>>::eq(_local4_param0_helper2, _local4_param1_helper2);
}
...
fn main() {
    ...
    test_function45(_param0 ,_param1);
