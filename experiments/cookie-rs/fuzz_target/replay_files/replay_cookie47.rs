...
fn test_function47(_param0 :&str ,_param1 :&str) {
    ...
    let _local1 = cookie::Cookie::<'_>::expires(_local1_param0_helper2);
    ...
    let _local3 = cookie::Cookie::<'_>::expires(_local3_param0_helper2);
    ...
    let _ = <cookie::Expiration as std::cmp::PartialEq::<cookie::Expiration>>::eq(_local4_param0_helper2, _local4_param1_helper2);
}
...
fn main() {
    ...
    test_function47(_param0 ,_param1);
