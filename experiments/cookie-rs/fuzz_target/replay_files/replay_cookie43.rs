...
fn test_function43(_param0 :&str ,_param1 :&str) {
    ...
    let _local3 = <cookie::CookieBuilder::<'_> as std::convert::From::<cookie::Cookie::<'_>>>::from(_local3_param0_helper1);
    let _local4_param0_helper1 = &(_local1);
    let _local4_param1_helper1 = &(_local3);
    let _ = <cookie::CookieBuilder::<'_> as std::cmp::PartialEq::<cookie::CookieBuilder::<'_>>>::eq(_local4_param0_helper1, _local4_param1_helper1);
}
...
fn main() {
    ...
    test_function43(_param0 ,_param1);
