...
fn test_function40(_param0 :&str ,_param1 :&str) {
    ...
    let _local3_param1_helper1 = _unwrap_result(_local2);
    let _local3_param1_helper2 = &(_local3_param1_helper1);
    let _ = <cookie::CookieBuilder::<'_> as std::cmp::PartialEq::<cookie::Cookie::<'_>>>::eq(_local3_param0_helper1, _local3_param1_helper2);
}
