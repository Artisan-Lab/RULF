...
fn test_function12(_param0 :&str) {
    ...
    let _local1 = <cookie::prefix::Secure as cookie::prefix::Prefix>::conform(_local1_param0_helper1);
    let _local2_param0_helper1 = &(_local1);
    let _ = cookie::Cookie::<'_>::name_value_trimmed(_local2_param0_helper1);
}
