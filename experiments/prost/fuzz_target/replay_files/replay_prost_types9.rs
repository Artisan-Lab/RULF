...
fn test_function9(_param0 :i32 ,_param1 :&str) {
    let _local0 = prost_types::field_descriptor_proto::Type::from_i32(_param0);
    let _local1 = prost_types::field_descriptor_proto::Type::from_str_name(_param1);
    ...
    let _ = <prost_types::field_descriptor_proto::Type as std::cmp::PartialEq::<prost_types::field_descriptor_proto::Type>>::eq(_local2_param0_helper2, _local2_param1_helper2);
}
