...
fn test_function27(_param0 :&str ,_param1 :i32) {
    ...
    let _ = <prost_types::field_descriptor_proto::Label as std::cmp::Ord>::cmp(_local2_param0_helper2, _local2_param1_helper2);
}
