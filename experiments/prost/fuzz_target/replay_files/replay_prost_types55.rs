...
fn test_function55(_param0 :&str ,_param1 :i32) {
    let _local0 = prost_types::file_options::OptimizeMode::from_str_name(_param0);
    let _local1 = <prost_types::file_options::OptimizeMode as std::convert::TryFrom::<i32>>::try_from(_param1);
    ...
    let _ = <prost_types::file_options::OptimizeMode as std::cmp::PartialEq::<prost_types::file_options::OptimizeMode>>::eq(_local2_param0_helper2, _local2_param1_helper2);
}
