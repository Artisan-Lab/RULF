...
fn test_function58(mut _param0 :i32 ,_param1 :&[u8]) {
    let _local0_param0_helper1 = &mut (_param0);
    let _: std::result::Result::<(), prost::DecodeError> = <i32 as prost::Message>::merge_length_delimited(_local0_param0_helper1, _param1);
}
