...
fn test_function46(_param0 :&str) {
    ...
    let _local1 = prost_types::method_options::IdempotencyLevel::from_str_name(_param0);
    ...
    let _: () = <prost_types::method_options::IdempotencyLevel as std::hash::Hash>::hash(_local2_param0_helper2, _local2_param1_helper1);
}
