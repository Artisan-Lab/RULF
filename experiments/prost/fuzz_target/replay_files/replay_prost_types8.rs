...
fn test_function8(_param0 :i32 ,_param1 :&str) {
    let _local0 = prost_types::method_options::IdempotencyLevel::from_i32(_param0);
    let _local1 = prost_types::method_options::IdempotencyLevel::from_str_name(_param1);
