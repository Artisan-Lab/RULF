...
fn test_function1(_param0 :i32 ,_param1 :&str) {
    let _local0 = prost_types::NullValue::from_i32(_param0);
    let _local1 = prost_types::NullValue::from_str_name(_param1);
    ...
    let _ = <prost_types::NullValue as std::cmp::PartialEq::<prost_types::NullValue>>::eq(_local2_param0_helper2, _local2_param1_helper2);
}
