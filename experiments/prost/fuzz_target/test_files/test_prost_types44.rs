...
fn test_function44(_param0 :&str) {
    ...
    let _local1 = prost_types::field_options::JsType::from_str_name(_param0);
    ...
    let _: () = <prost_types::field_options::JsType as std::hash::Hash>::hash(_local2_param0_helper2, _local2_param1_helper1);
}
