...
fn test_function40(_param0 :&str) {
    ...
    let _local1 = prost_types::field_options::CType::from_str_name(_param0);
    ...
    let _: () = <prost_types::field_options::CType as std::hash::Hash>::hash(_local2_param0_helper2, _local2_param1_helper1);
}
