...
fn test_function5(_param0 :i32 ,_param1 :&str) {
    let _local0 = prost_types::field_descriptor_proto::Label::from_i32(_param0);
    let _local1 = prost_types::field_descriptor_proto::Label::from_str_name(_param1);
