...
fn test_function6(_param0 :i32 ,_param1 :&str) {
    let _local0 = prost_types::field_options::JsType::from_i32(_param0);
    let _local1 = prost_types::field_options::JsType::from_str_name(_param1);
