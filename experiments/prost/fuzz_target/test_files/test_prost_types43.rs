...
fn test_function43(_param0 :&str) {
    ...
    let _local1 = prost_types::field_descriptor_proto::Label::from_str_name(_param0);
    ...
    let _: () = <prost_types::field_descriptor_proto::Label as std::hash::Hash>::hash(_local2_param0_helper2, _local2_param1_helper1);
}
