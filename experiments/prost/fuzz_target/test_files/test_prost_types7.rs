...
fn test_function7(_param0 :i32 ,_param1 :&str) {
    let _local0 = prost_types::file_options::OptimizeMode::from_i32(_param0);
    let _local1 = prost_types::file_options::OptimizeMode::from_str_name(_param1);
