...
fn test_function12(_param0 :&str) {
    let _local0 = prost_types::NullValue::from_str_name(_param0);
    let _local1 = <prost_types::NullValue as std::default::Default>::default();
    ...
    let _ = <prost_types::NullValue as std::cmp::PartialOrd::<prost_types::NullValue>>::partial_cmp(_local2_param0_helper2, _local2_param1_helper1);
}
