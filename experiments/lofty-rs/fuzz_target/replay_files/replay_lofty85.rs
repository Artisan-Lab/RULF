...
fn test_function85(_param0 :&[u8] ,_param1 :&[u8] ,_param2 :&str ,_param3 :bool) {
    ...
    let _ = lofty::Tag::get_binary(_local6_param0_helper1, _local6_param1_helper1, _param3);
}
...
fn main() {
    ...
    let _param0 = _to_slice::<u8>(data, 1 + 0 * dynamic_length, 1 + 1 * dynamic_length);
    ...
    test_function85(_param0 ,_param1 ,_param2 ,_param3);
