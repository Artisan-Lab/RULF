...
fn test_function73(_param0 :&str) {
    ...
    let mut _local2 = <lofty::mp4::Ilst as std::convert::From::<lofty::Tag>>::from(_local1);
    ...
    let _ = <lofty::mp4::Ilst as lofty::Accessor>::set_artist(_local5_param0_helper1, _local5_param1_helper1);
}
