...
fn test_function115(_param0 :u8 ,_param1 :u8) {
    ...
    let _ = <lofty::id3::v2::ChannelType as std::cmp::PartialEq::<lofty::id3::v2::ChannelType>>::eq(_local2_param0_helper2, _local2_param1_helper2);
}
