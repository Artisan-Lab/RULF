...
fn test_function134(_param0 :usize ,_param1 :usize ,_param2 :lofty::PictureInformation) {
    ...
    let _ = <lofty::ogg::VorbisComments as lofty::ogg::OggPictureStorage>::set_picture(_local6_param0_helper1, _param1, _local5, _param2);
}
...
fn main() {
    ...
    let _param2 = lofty::PictureInformation{width: _to_u32(data, 16), height: _to_u32(data, 20), color_depth: _to_u32(data, 24), num_colors: _to_u32(data, 28)};
    test_function134(_param0 ,_param1 ,_param2);
