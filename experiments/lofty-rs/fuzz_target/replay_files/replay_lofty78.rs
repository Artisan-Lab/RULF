...
fn test_function78(_param0 :&str) {
    let mut _local0 = <lofty::musepack::MpcFile as std::default::Default>::default();
    let _local1 = <lofty::ape::ApeTag as std::default::Default>::default();
    let _local2_param0_helper1 = &mut (_local0);
    let mut _local2 = lofty::musepack::MpcFile::set_ape(_local2_param0_helper1, _local1);
    ...
    let _ = <lofty::ape::ApeTag as lofty::Accessor>::set_comment(_local5_param0_helper2, _local5_param1_helper1);
}
