...
fn test_function137(_param0 :usize ,_param1 :usize) {
    ...
    let _local2 = lofty::Tag::remove_picture(_local2_param0_helper1, _param0);
    ...
    let _ = <lofty::Picture as std::cmp::PartialEq::<lofty::Picture>>::eq(_local6_param0_helper1, _local6_param1_helper1);
}
...
fn main() {
    ...
    test_function137(_param0 ,_param1);
