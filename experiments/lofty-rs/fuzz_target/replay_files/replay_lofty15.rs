...
fn test_function15(_param0 :&[u8] ,_param1 :&str) {
    let _local0 = lofty::FileType::from_buffer(_param0);
    let _local1_param0_helper1 = _unwrap_option(_local0);
    let _local1 = lofty::error::FileDecodingError::new(_local1_param0_helper1, _param1);
    let _ = <lofty::error::LoftyError as std::convert::From::<lofty::error::FileDecodingError>>::from(_local1);
}
