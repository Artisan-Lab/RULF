...
fn test_function1(_param0 :&str) {
    ...
    let _local4 = lofty::id3::v2::Id3v2Tag::remove_user_text(_local4_param0_helper1, _param0);
    ...
    let _ = lofty::id3::v2::Id3v2Tag::insert(_local5_param0_helper2, _local5_param1_helper1);
}
