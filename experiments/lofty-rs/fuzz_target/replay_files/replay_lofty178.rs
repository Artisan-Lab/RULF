...
fn test_function178(_param0 :usize ,_param1 :lofty::PictureInformation ,_param2 :bool) {
    ...
    let _ = lofty::Picture::as_flac_bytes(_local3_param0_helper1, _param1, _param2);
}
