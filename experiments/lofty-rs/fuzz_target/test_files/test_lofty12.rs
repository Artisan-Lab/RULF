...
fn test_function12(_param0 :&str ,_param1 :&str) {
    ...
    let mut _local2 = <lofty::iff::wav::RIFFInfoList as std::convert::From::<lofty::Tag>>::from(_local1);
    ...
    let _ = lofty::iff::wav::RIFFInfoList::insert(_local7_param0_helper1, _local7_param1_helper1, _local7_param2_helper1);
}
