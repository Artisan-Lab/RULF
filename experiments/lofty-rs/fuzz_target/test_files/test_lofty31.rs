...
fn test_function31(_param0 :&str ,_param1 :&str) {
    let _local0 = lofty::MimeType::from_str(_param0);
    let _local1 = lofty::MimeType::from_str(_param1);
    let _local2_param0_helper1 = &(_local0);
    let _local2_param1_helper1 = &(_local1);
    let _ = <lofty::MimeType as std::cmp::PartialEq::<lofty::MimeType>>::eq(_local2_param0_helper1, _local2_param1_helper1);
}
