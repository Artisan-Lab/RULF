...
fn test_function70(_param0 :&str) {
    let mut _local0 = <lofty::aac::AacFile as std::default::Default>::default();
    let _local1 = <lofty::id3::v1::Id3v1Tag as std::default::Default>::default();
    let _local2_param0_helper1 = &mut (_local0);
    let mut _local2 = lofty::aac::AacFile::set_id3v1(_local2_param0_helper1, _local1);
    ...
    let _ = <lofty::id3::v1::Id3v1Tag as lofty::Accessor>::set_title(_local5_param0_helper2, _local5_param1_helper1);
}
