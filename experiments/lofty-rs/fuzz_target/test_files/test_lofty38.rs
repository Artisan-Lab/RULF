...
fn test_function38(_param0 :&str ,_param1 :&str) {
    ...
    let mut _local2 = lofty::id3::v2::Id3v2Tag::new();
    let _local3_param0_helper1 = &mut (_local2);
    let _local3 = lofty::id3::v2::Id3v2Tag::remove_user_text(_local3_param0_helper1, _param1);
    ...
    let _ = <lofty::id3::v2::Frame::<'_> as std::cmp::PartialEq::<lofty::id3::v2::Frame::<'_>>>::eq(_local4_param0_helper2, _local4_param1_helper2);
}
