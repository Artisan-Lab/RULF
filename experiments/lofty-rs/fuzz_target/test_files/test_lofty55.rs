...
fn test_function55(_param0 :&[u8] ,_param1 :&str) {
    ...
    let _local4 = lofty::iff::wav::RIFFInfoList::remove(_local4_param0_helper1, _param1);
    let _local5_param0_helper1 = &mut (_local2);
    let _local5_param1_helper1 = _unwrap_option(_local4);
    let _ = <lofty::Tag as lofty::Accessor>::set_comment(_local5_param0_helper1, _local5_param1_helper1);
}
