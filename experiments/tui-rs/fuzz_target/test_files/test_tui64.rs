...
fn test_function64(_param0 :u16) {
    let _local0 = tui::style::Modifier::from_bits(_param0);
    let _local1_param0_helper1 = _unwrap_option(_local0);
    let _local1 = <tui::style::Modifier as std::ops::Not>::not(_local1_param0_helper1);
    let _local2_param0_helper1 = &(_local1);
    let _ = tui::style::Modifier::is_empty(_local2_param0_helper1);
}
