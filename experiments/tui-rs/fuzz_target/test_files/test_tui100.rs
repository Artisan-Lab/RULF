...
fn test_function100(_param0 :u16) {
    ...
    let _ = <tui::style::Modifier as std::ops::BitAndAssign::<tui::style::Modifier>>::bitand_assign(_local2_param0_helper1, _local2_param1_helper1);
}
