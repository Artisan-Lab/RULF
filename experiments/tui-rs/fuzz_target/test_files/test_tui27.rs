...
fn test_function27(_param0 :&str ,_param1 :tui::layout::Rect ,_param2 :u16 ,_param3 :u16 ,_param4 :u16) {
    let _local0 = <tui::text::Span::<'_> as std::convert::From::<&str>>::from(_param0);
    let mut _local1 = tui::buffer::Buffer::empty(_param1);
    let _local2_param0_helper1 = &mut (_local1);
    let _local2_param3_helper1 = &(_local0);
    let _ = tui::buffer::Buffer::set_span(_local2_param0_helper1, _param2, _param3, _local2_param3_helper1, _param4);
}
...
fn main() {
    fuzz!(|data: &[u8]| {
        ...
        test_function27(_param0 ,_param1 ,_param2 ,_param3 ,_param4);
    });
}
