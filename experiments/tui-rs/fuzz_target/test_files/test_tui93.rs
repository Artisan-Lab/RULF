...
fn test_function93(_param0 :u16) {
    ...
    let _ = <tui::style::Modifier as std::cmp::PartialOrd::<tui::style::Modifier>>::partial_cmp(_local2_param0_helper1, _local2_param1_helper2);
}
