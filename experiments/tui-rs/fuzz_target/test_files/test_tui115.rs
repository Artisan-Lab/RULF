...
fn test_function115(_param0 :u32) {
    let _local0 = tui::widgets::Borders::empty();
    ...
    let _ = <tui::widgets::Borders as std::cmp::PartialOrd::<tui::widgets::Borders>>::partial_cmp(_local2_param0_helper1, _local2_param1_helper2);
}
