...
fn test_function98(_param0 :u16) {
    ...
    let _ = <tui::style::Modifier as std::ops::BitXorAssign::<tui::style::Modifier>>::bitxor_assign(_local2_param0_helper1, _local2_param1_helper1);
}
