...
fn test_function7(_param0 :&str) {
    ...
    let _local1 = <std::string::String as std::convert::From::<tui::text::Spans::<'_>>>::from(_local0);
    let _ = <tui::text::Text::<'_> as std::convert::From::<std::string::String>>::from(_local1);
}
