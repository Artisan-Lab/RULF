...
fn test_function102(_param0 :u16) {
    ...
    let _ = <tui::style::Modifier as std::ops::SubAssign::<tui::style::Modifier>>::sub_assign(_local2_param0_helper1, _local2_param1_helper1);
}
