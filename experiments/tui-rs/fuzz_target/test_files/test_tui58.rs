...
fn test_function58(_param0 :u32 ,_param1 :u32) {
    let _local0 = tui::widgets::Borders::from_bits(_param0);
    let _local1 = tui::widgets::Borders::from_bits_truncate(_param1);
    let _local2_param0_helper1 = _unwrap_option(_local0);
    let _local2_param0_helper2 = &(_local2_param0_helper1);
    let _ = tui::widgets::Borders::intersects(_local2_param0_helper2, _local1);
}
