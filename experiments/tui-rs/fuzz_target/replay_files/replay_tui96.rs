...
fn test_function96(_param0 :u16) {
    ...
    let _ = <tui::style::Modifier as std::ops::BitOrAssign::<tui::style::Modifier>>::bitor_assign(_local2_param0_helper1, _local2_param1_helper1);
}
