...
fn test_function9(_param0 :&str ,_param1 :u16) {
    let _local0 = <std::vec::Vec::<u8, std::alloc::Global> as std::convert::From::<&str>>::from(_param0);
    let _local1: tui::widgets::Table::<'_> = tui::widgets::Table::<'_>::new(_local0);
    let _ = tui::widgets::Table::<'_>::column_spacing(_local1, _param1);
}
