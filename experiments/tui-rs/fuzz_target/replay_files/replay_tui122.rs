...
fn test_function122(_param0 :u32) {
    ...
    let _ = <tui::widgets::Borders as std::ops::BitAndAssign::<tui::widgets::Borders>>::bitand_assign(_local2_param0_helper1, _local2_param1_helper1);
}
