...
fn test_function45(_param0 :&str ,_param1 :u16 ,_param2 :u16) {
    ...
    let _: std::io::Result::<()> = <tui::backend::CrosstermBackend::<std::vec::Vec::<u8, std::alloc::Global>> as tui::backend::Backend>::set_cursor(_local2_param0_helper1, _param1, _param2);
}
