...
fn test_function38(_param0 :&str ,_param1 :&[u8]) {
    ...
    let _: std::io::Result::<usize> = <tui::backend::CrosstermBackend::<std::vec::Vec::<u8, std::alloc::Global>> as std::io::Write>::write(_local2_param0_helper1, _param1);
}
