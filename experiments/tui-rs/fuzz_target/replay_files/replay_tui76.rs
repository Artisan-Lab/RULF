...
fn test_function76(_param0 :tui::layout::Rect ,_param1 :u16 ,_param2 :u16) {
    let _local0 = tui::buffer::Buffer::empty(_param0);
    let _local1 = tui::backend::TestBackend::new(_param1, _param2);
    let _local2_param0_helper1 = &(_local1);
    let _local2_param1_helper1 = &(_local0);
    let _ = tui::backend::TestBackend::assert_buffer(_local2_param0_helper1, _local2_param1_helper1);
}
