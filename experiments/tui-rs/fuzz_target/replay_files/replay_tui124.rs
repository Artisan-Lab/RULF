...
fn test_function124(_param0 :u32) {
    ...
    let _ = <tui::widgets::Borders as std::ops::SubAssign::<tui::widgets::Borders>>::sub_assign(_local2_param0_helper1, _local2_param1_helper1);
}
