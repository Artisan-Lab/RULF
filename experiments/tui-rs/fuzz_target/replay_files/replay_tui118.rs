...
fn test_function118(_param0 :u32) {
    ...
    let _ = <tui::widgets::Borders as std::ops::BitOrAssign::<tui::widgets::Borders>>::bitor_assign(_local2_param0_helper1, _local2_param1_helper1);
}
