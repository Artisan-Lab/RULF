...
fn test_function24(_param0 :tui::layout::Rect ,_param1 :&str ,_param2 :u16 ,_param3 :u16 ,_param4 :u16 ,_param5 :usize) {
    ...
    let _: (u16 ,u16) = tui::buffer::Buffer::set_stringn(_local5_param0_helper1, _param3, _param4, _local1, _param5, _local4);
}
...
fn main() {
    ...
    //actual body emit
    if data.len() < 23 {return;}
    let dynamic_length = (data.len() - 22) / 1;
    let _param0 = tui::layout::Rect{x: _to_u16(data, 0), y: _to_u16(data, 2), width: _to_u16(data, 4), height: _to_u16(data, 6)};
    let _param1 = _to_str(data, 22 + 0 * dynamic_length, data.len());
    let _param2 = _to_u16(data, 8);
    let _param3 = _to_u16(data, 10);
    let _param4 = _to_u16(data, 12);
    let _param5 = _to_usize(data, 14);
    test_function24(_param0 ,_param1 ,_param2 ,_param3 ,_param4 ,_param5);
