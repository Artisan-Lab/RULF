...
fn test_function25(_param0 :&str ,_param1 :&str) {
    ...
    let _local1 = <tui::text::Span::<'_> as std::convert::From::<&str>>::from(_param1);
    let _local2_param0_helper1 = &(_local0);
    let _local2_param1_helper1 = &(_local1);
    let _ = <tui::text::Span::<'_> as std::cmp::PartialEq::<tui::text::Span::<'_>>>::eq(_local2_param0_helper1, _local2_param1_helper1);
}
