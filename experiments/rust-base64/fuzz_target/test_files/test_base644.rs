...
fn test_function4(_param0 :&str) {
    let _local0 = <base64::engine::general_purpose::GeneralPurposeConfig as std::default::Default>::default();
    ...
    let _ = base64::engine::general_purpose::GeneralPurpose::new(_local2_param0_helper2, _local0);
}
