...
fn test_function10(_param0 :&str ,_param1 :&str) {
    ...
    let _: std::io::Result::<base64::write::EncoderStringWriter::<'_, base64::engine::general_purpose::GeneralPurpose, std::string::String>> = base64::write::EncoderWriter::<'_, base64::engine::general_purpose::GeneralPurpose, base64::write::EncoderStringWriter::<'_, base64::engine::general_purpose::GeneralPurpose, std::string::String>>::finish(_local8_param0_helper1);
}
