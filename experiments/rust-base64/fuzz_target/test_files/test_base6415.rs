...
fn test_function15(_param0 :&str ,_param1 :&str) {
    ...
    let _local8_param0_helper1 = &(_local7);
    let _: bool = <base64::write::EncoderWriter::<'_, base64::engine::general_purpose::GeneralPurpose, base64::write::EncoderStringWriter::<'_, base64::engine::general_purpose::GeneralPurpose, std::string::String>> as std::io::Write>::is_write_vectored(_local8_param0_helper1);
}
