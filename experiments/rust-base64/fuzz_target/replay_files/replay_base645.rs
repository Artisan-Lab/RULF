...
fn test_function5(_param0 :&str ,_param1 :&[u8]) {
    ...
    let _: base64::display::Base64Display::<'_, '_, base64::engine::general_purpose::GeneralPurpose> = base64::display::Base64Display::<'_, '_, base64::engine::general_purpose::GeneralPurpose>::new(_param1, _local3_param1_helper1);
}
