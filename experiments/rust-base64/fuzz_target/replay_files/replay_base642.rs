...
fn test_function2(_param0 :&str ,_param1 :&[u8]) {
    ...
    let _local3: base64::read::DecoderReader::<'_, base64::engine::general_purpose::GeneralPurpose, &[u8]> = base64::read::DecoderReader::<'_, base64::engine::general_purpose::GeneralPurpose, &[u8]>::new(_param1, _local3_param1_helper1);
    let _: &[u8] = base64::read::DecoderReader::<'_, base64::engine::general_purpose::GeneralPurpose, &[u8]>::into_inner(_local3);
}
