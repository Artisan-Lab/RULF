...
fn test_function8(_param0 :&str ,_param1 :&str) {
    ...
    let mut _local4: std::string::String = base64::write::EncoderStringWriter::<'_, base64::engine::general_purpose::GeneralPurpose, std::string::String>::into_inner(_local3);
    let _local5_param0_helper1 = &mut (_local4);
    let _ = <std::string::String as base64::write::StrConsumer>::consume(_local5_param0_helper1, _param1);
}
