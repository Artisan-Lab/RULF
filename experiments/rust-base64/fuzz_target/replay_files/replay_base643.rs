...
fn test_function3(_param0 :&str ,_param1 :&str) {
    ...
    let _local1 = base64::alphabet::Alphabet::new(_param1);
    ...
    let _ = <base64::alphabet::Alphabet as std::cmp::PartialEq::<base64::alphabet::Alphabet>>::eq(_local2_param0_helper2, _local2_param1_helper2);
}
